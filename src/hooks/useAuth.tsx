            ...
            setTimeout(async () => {
              try {
                ...
                if (mounted) {
                  ...
                  const adminRoles = ['super_admin', 'admin', 'member', 'viewer', 'guest', 'sales', 'sales_lead', 'blog_writer', 'lead_gen', 'dev_tester', 'accounts_manager', 'accounts_payroll', 'accounts', 'claims_agent', 'claims_manager'];
