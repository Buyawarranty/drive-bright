  ...
  const addOns: AddOnInfo[] = [
    {
      ...
      displayPrice: autoIncluded.includes('breakdown') ? 'FREE' : `£${(4 * durationMonths).toFixed(0)}`
    },
    {
      key: 'rental',
      name: 'Hire Car',
      ...
      displayPrice: autoIncluded.includes('rental') ? 'FREE' : `£${(7 * durationMonths).toFixed(0)}`
    },
    {
      key: 'tyre',
      name: 'Tyre Cover',
      ...
      displayPrice: autoIncluded.includes('tyre') ? 'FREE' : `£${(8 * durationMonths).toFixed(0)}`
    },
    {
      key: 'wearAndTear',
      name: 'Wear & Tear',
      ...
      displayPrice: autoIncluded.includes('wearAndTear') ? 'FREE' : `£${(10 * durationMonths).toFixed(0)}`
    },
    {
      key: 'european',
      name: 'European Cover',
      ...
      displayPrice: autoIncluded.includes('european') ? 'FREE' : `£${(6 * durationMonths).toFixed(0)}`
    },
    {
      key: 'motRepair',
      name: 'MOT Repair',
      ...
      displayPrice: autoIncluded.includes('motRepair') ? 'FREE' : `£${(4 * durationMonths).toFixed(0)}`
    },
    {
      key: 'motFee',
      name: 'MOT Test Fee',
      ...
      displayPrice: autoIncluded.includes('motFee') ? 'FREE' : `£${(2 * durationMonths).toFixed(0)}`
    },
    {
      key: 'lostKey',
      name: 'Lost Key Cover',
      ...
      displayPrice: autoIncluded.includes('lostKey') ? 'FREE' : `£${(3 * durationMonths).toFixed(0)}`
    },
    {
      key: 'consequential',
      ...
      displayPrice: autoIncluded.includes('consequential') ? 'FREE' : `£${(5 * durationMonths).toFixed(0)}`
    },
    {
      key: 'transfer',
      name: 'Transfer Cover',
