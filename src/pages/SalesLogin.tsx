...
const SalesLogin = () => {
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      if (session?.user) {
        ...
        if (userRoles.includes('sales') || userRoles.includes('sales_lead') || userRoles.includes('admin') || userRoles.includes('super_admin') || userRoles.includes('member')) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userRoles = roles?.map(r => r.role) || [];
      const hasAccess = userRoles.includes('sales') || userRoles.includes('sales_lead') || userRoles.includes('admin') || userRoles.includes('super_admin') || userRoles.includes('member');
