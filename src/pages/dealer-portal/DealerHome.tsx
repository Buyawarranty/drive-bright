...
const DealerHome = () => {
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* Hero Section — matches retail homepage layout */}
      <section className="bg-white pt-3 sm:pt-8 lg:pt-16 pb-6 sm:pb-8 lg:pb-12 px-3 sm:px-0">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center">
            ...
            <div className="space-y-3 sm:space-y-4 px-0 flex flex-col justify-center">
              ...
              <div className="space-y-2 mb-2 sm:mb-4">
                <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black leading-tight">
                  <span className="text-[#333]">Dealer warranties </span>
              ...
              {/* Reg plate style CTA — mirrors retail reg input styling */}
              <div className="space-y-3 w-full max-w-md mx-auto lg:mx-0">
                <div className="flex items-stretch rounded-lg overflow-hidden shadow-lg border-2 border-black w-full">
                  ...
                  {/* CTA Button styled like reg plate */}
                  <Link
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <Link to="/dealer-portal/login" className="flex-1">
                    <Button size="lg" variant="outline" className="w-full border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white font-bold text-sm sm:text-base py-5">
                      Dealer Login
                    </Button>
                  </Link>
                </div>
            ...
            {/* Right Content - Hero Image — same as retail */}
      ...
      <section className="bg-orange-500 py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link to="/dealer-portal/signup">
            <Button size="lg" className="bg-white text-orange-600 hover:bg-gray-100 text-base sm:text-lg px-8 py-6 font-bold">
