...
const SALES_TABS = ['overview', 'new-leads', 'whatsapp-leads', 'recontact-leads', 'get-quote', 'selling-tips', 'discount-codes', 'timesheets', 'staff-hub', 'agent-feedback', 'staff-system-reports', 'unsubscribe', 'account'];
const SALES_LEAD_TABS = ['overview', 'new-leads', 'whatsapp-leads', 'call-tracking', 'recontact-leads', 'get-quote', 'sales-scoreboard', 'customers', 'collect-payments', 'analytics', 'selling-tips', 'discount-codes', 'timesheets', 'attendance', 'staff-hub', 'agent-feedback', 'staff-system-reports', 'unsubscribe', 'account'];
