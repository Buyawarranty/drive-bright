  ...
  useEffect(() => {
    const loadPage = async () => {
      ...
      const knownRoutes = [
        ...
        'home', 'warranty-types/bmw', 'warranty-types/mercedes', 'warranty-types/honda', 'warranty-types/toyota', 'warranty-types/ford', 'warranty-types/kia', 'warranty-types/hyundai', 'warranty-types/ev'
      ];
