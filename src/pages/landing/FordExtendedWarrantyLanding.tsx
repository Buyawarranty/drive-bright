...
import fordKuga from '@/assets/ford-models/ford-kuga-extended-warranty.jpg';
...
const fordModels = [
  ...
  { label: 'Focus', examples: 'EcoBoost, TDCi', img: fordFocus, alt: 'Ford Focus extended warranty cover — EcoBoost petrol and TDCi diesel hatchback' },
  { label: 'Mondeo', examples: 'Petrol, Diesel, Hybrid', img: fordMondeo, alt: 'Ford Mondeo extended warranty cover — saloon and estate' },
  { label: 'Kuga', examples: 'SUV petrol, diesel, PHEV', img: fordKuga, alt: 'Ford Kuga SUV extended warranty cover — petrol, diesel and plug-in hybrid' },
  { label: 'Puma / EcoSport', examples: 'Compact SUV', img: fordPuma, alt: 'Ford Puma and EcoSport compact SUV extended warranty cover' },
  { label: 'Mustang Mach-E (EV)', examples: 'Electric range', img: fordMachE, alt: 'Ford Mustang Mach-E electric vehicle extended warranty cover' },
];
...
const faqs = [
  { q: 'How much does Ford extended warranty cover cost?', a: 'Prices start from £19/month. Your exact price depends on your Ford model, age, mileage and the level of cover you choose.' },
  { q: 'What Ford models can you cover?', a: 'We can provide cover for many Ford models, subject to age, mileage, vehicle condition and eligibility checks. Vehicles up to 15 years old and 150,000 miles are typically eligible.' },
  ...
  { q: 'Is Buyawarranty part of Ford?', a: 'No. Buyawarranty is an independent UK warranty provider and is not affiliated with Ford Motor Company.' },
...
const FordExtendedWarrantyLanding: React.FC = () => {
  ...
  const submitToMainJourney = async () => {
    ...
    try {
      ...
      try {
        ...
        if (data?.found) {
          extra = { make: data.make || 'FORD', model: data.model, fuelType: data.fuelType, transmission: data.transmission, year: data.yearOfManufacture, vehicleType: 'car', manufactureDate: data.manufactureDate };
        }
      } catch { /* ok */ }
  ...
  return (
    <>
      <SEOHead
        ...
        description="Protect your Ford from unexpected repair bills with flexible UK warranty cover from £19/month. Instant online quote in under 60 seconds."
        keywords="Ford extended warranty, Ford warranty quote, Ford warranty UK, used Ford warranty, Ford repair cover, Ford warranty cost, Ford Fiesta warranty, Ford Focus warranty, Ford Kuga warranty"
        canonical="https://buyawarranty.co.uk/car-extended-warranty/ford/"
        ogImage={`https://buyawarranty.co.uk${fordHero}`}
        ogImageAlt="Ford Extended Warranty Cover from £19/month"
      ...
      <div className="min-h-screen bg-white text-slate-900 pb-24 md:pb-0 font-sans">
        ...
        <header className="sticky top-0 z-40 bg-white border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-xs px-4">Get my Ford quote</Button>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_1fr] gap-6 lg:gap-10 items-start">
            <div>
              <h1 className="text-[28px] sm:text-4xl md:text-5xl lg:text-[52px] font-black text-[#0F172A] leading-[1.05] tracking-tight">
                Ford Extended Warranty Cover<br className="hidden sm:block"/>{' '}
                  ...
                  <>
                    ...
                    <div className="mt-4">
                      <MileageQuickSelect
                        ...
                        ctaLabels={{
                          enterReg: 'Enter your Ford reg above',
                          selectMileage: 'Select mileage to see your price',
                          submit: 'Get my Ford quote',
                        }}
                      />
                    </div>
                    ...
                    <div className="md:hidden mt-5 flex justify-center">
                      <img
                        src={fordHero}
                        alt="Friendly panda mascot with a Ford — extended warranty cover"
            ...
            <div className="hidden md:block lg:order-last">
              <div className="relative">
                <img src={fordHero} alt="Friendly panda mascot with a Ford — extended warranty cover" className="w-full h-auto rounded-2xl" loading="eager" />
              </div>
              <div className="mt-5 flex flex-col items-center gap-3">
                ...
                <p className="text-center text-[12.5px] text-slate-600 leading-snug max-w-xs">
                  ...
                  Not affiliated with Ford. Flexible cover from 60p a day.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <h2 className="text-3xl md:text-[40px] font-black text-[#0F172A] leading-tight">
                Why Ford owners choose <span className="text-[#F97316]">Buyawarranty</span>
              </h2>
              <p className="mt-3 text-slate-600 text-[15px] md:text-base">
                Ford repairs can add up. We help make unexpected costs easier to manage with simple warranty cover and UK-based support.
              </p>
            </div>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              ...
              <p className="text-center text-[13px] text-slate-600 leading-snug max-w-md">
                Independent UK warranty provider. Not affiliated with Ford.<br />
              ...
              <Button onClick={scrollToQuote} className="mt-2 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Check my Ford price <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button onClick={scrollToQuote} className="animate-breathing bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Get my Ford quote <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Ford models we cover</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Cover available for most Ford models and engine types, subject to eligibility.</p>
            </div>
            ...
            <div className="text-center mt-6">
              <button onClick={scrollToQuote} className="inline-flex items-center gap-1 text-[#F97316] font-bold text-sm hover:underline">
                View all Ford models we cover <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-white to-slate-50 border-t border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">What does Ford warranty cover?</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Eight major systems protected, so you can drive your Ford with confidence.</p>
            </div>
            ...
            <div className="text-center mt-6">
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                See my Ford cover options <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-14 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-6">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Additional Ford cover options</h2>
            </div>
        ...
        <section className="py-12 md:py-16 bg-white border-t border-slate-100">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              ...
              <p className="mt-3 text-sm md:text-base text-slate-600">Got questions before you get a quote? Here are the answers Ford owners ask us most.</p>
            </div>
                    ...
                    {open && (
                      <div className="mt-2">
                        ...
                        {i === 0 && (
                          ...
                          >
                            Check my Ford price <ArrowRight className="w-4 h-4" />
                          </button>
                        )}
                      </div>
                    )}
        ...
        <div className="fixed bottom-0 inset-x-0 z-50 md:hidden bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] p-3">
          <div className="flex gap-2">
            ...
            <Button onClick={scrollToQuote} className="flex-1 bg-[#16A34A] hover:bg-[#15803D] text-white font-bold h-12">Get my Ford quote</Button>
          </div>
        </div>
      </div>
...
export default FordExtendedWarrantyLanding;
