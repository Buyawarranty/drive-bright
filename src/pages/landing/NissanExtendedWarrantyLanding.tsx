...
const NissanExtendedWarrantyLanding: React.FC = () => {
  ...
  return (
    <>
      ...
      <ProductSchema name="Nissan Extended Warranty" description="Flexible Nissan warranty cover" price="19" brand="BuyaWarranty" category="Vehicle Warranty" image="https://buyawarranty.co.uk/logo.png" availability="https://schema.org/InStock" areaServed="GB" />
