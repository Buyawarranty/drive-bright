...
import nissanXtrail from '@/assets/nissan-models/nissan-xtrail-extended-warranty.jpg';
import nissanLeaf from '@/assets/nissan-models/nissan-leaf-ev-extended-warranty.jpg';
import nissanAriya from '@/assets/nissan-models/nissan-ariya-ev-extended-warranty.jpg';

const nissanModels = [
  { label: 'Micra', examples: 'Supermini hatchback', img: nissanMicra, alt: 'Nissan Micra extended warranty cover — supermini hatchback' },
  { label: 'Juke', examples: 'Compact crossover', img: nissanJuke, alt: 'Nissan Juke extended warranty cover — compact crossover SUV' },
  { label: 'Qashqai', examples: 'Family SUV, e-Power', img: nissanQashqai, alt: 'Nissan Qashqai extended warranty cover — family SUV and e-Power hybrid' },
  { label: 'X-Trail', examples: '7-seat SUV, e-Power', img: nissanXtrail, alt: 'Nissan X-Trail extended warranty cover — 7-seat SUV and e-Power hybrid' },
  { label: 'Leaf (EV)', examples: 'Electric hatchback', img: nissanLeaf, alt: 'Nissan Leaf electric hatchback extended warranty cover' },
  { label: 'Ariya (EV)', examples: 'Electric SUV', img: nissanAriya, alt: 'Nissan Ariya electric SUV extended warranty cover' },
];
...
const faqs = [
  { q: 'How much does Nissan extended warranty cover cost?', a: 'Prices start from £19/month. Your exact price depends on your Nissan model, age, mileage and the level of cover you choose.' },
  { q: 'What Nissan models can you cover?', a: 'We can provide cover for many Nissan models — including the Micra, Note, Juke, Qashqai, X-Trail, Pulsar, Navara and electric models like the Leaf and Ariya — subject to age, mileage, vehicle condition and eligibility checks. Vehicles up to 15 years old and 150,000 miles are typically eligible.' },
  ...
  { q: 'Is Buyawarranty part of Nissan?', a: 'No. Buyawarranty is an independent UK warranty provider and is not affiliated with Nissan Motor Co. Ltd.' },
...
const NissanExtendedWarrantyLanding: React.FC = () => {
  ...
  const scrollToQuote = () => {
    trackButtonClick('nissan_ppc_cta');
  ...
  const submitToMainJourney = async () => {
    ...
    try {
      ...
      try {
        ...
        if (data?.found) {
          extra = { make: data.make || 'NISSAN', model: data.model, fuelType: data.fuelType, transmission: data.transmission, year: data.yearOfManufacture, vehicleType: 'car', manufactureDate: data.manufactureDate };
        }
      } catch { /* ok */ }
  ...
  return (
    <>
      <SEOHead
        title="Nissan Extended Warranty Cover from £19/month | Quote"
        description="Protect your Nissan from unexpected repair bills with flexible UK warranty cover from £19/month. Instant online quote in under 60 seconds."
        keywords="Nissan extended warranty, Nissan warranty quote, Nissan warranty UK, used Nissan warranty, Nissan repair cover, Nissan warranty cost, Nissan Qashqai warranty, Nissan Juke warranty, Nissan X-Trail warranty, Nissan Leaf warranty, Nissan Ariya warranty"
        canonical="https://buyawarranty.co.uk/car-extended-warranty/nissan/"
        ogImage={`https://buyawarranty.co.uk${nissanHero}`}
        ogImageAlt="Nissan Extended Warranty Cover from £19/month"
        geoRegion="GB" geoPlacename="United Kingdom"
      />
      <OrganizationSchema />
      <WebPageSchema name="Nissan Extended Warranty" description="Nissan extended warranty cover from £19/month." url="https://buyawarranty.co.uk/car-extended-warranty/nissan/" />
      <FAQSchema faqs={faqs.map(f => ({ question: f.q, answer: f.a }))} />
      <Helmet>
        <script type="application/ld+json">{JSON.stringify({"@context": "https://schema.org", "@type": "Product", "name": "Nissan Extended Warranty", "description": "Flexible Nissan warranty cover from \u00a319/month. Covers engine, gearbox, electrics and more across all Nissan models.", "brand": {"@type": "Brand", "name": "Buy A Warranty"}, "category": "Vehicle Extended Warranty", "image": "https://buyawarranty.co.uk/lovable-uploads/53652a24-3961-4346-bf9d-6588ef727aeb.png", "offers": {"@type": "Offer", "url": "https://buyawarranty.co.uk/car-extended-warranty/nissan/", "priceCurrency": "GBP", "price": "19", "availability": "https://schema.org/InStock", "seller": {"@type": "Organization", "name": "Buy A Warranty"}}, "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "2847", "bestRating": "5", "worstRating": "1"}})}</script>
      </Helmet>
      <BreadcrumbSchema items={[{ name: 'Home', url: 'https://buyawarranty.co.uk/' }, { name: 'Nissan Extended Warranty', url: 'https://buyawarranty.co.uk/car-extended-warranty/nissan/' }]} />
      ...
      <div className="min-h-screen bg-white text-slate-900 pb-24 md:pb-0 font-sans">
        ...
        <header className="sticky top-0 z-40 bg-white border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-xs px-4">Get my Nissan quote</Button>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_1fr] gap-6 lg:gap-10 items-start">
            <div>
              <h1 className="text-[28px] sm:text-4xl md:text-5xl lg:text-[52px] font-black text-[#0F172A] leading-[1.05] tracking-tight">
                Nissan Extended Warranty Cover<br className="hidden sm:block"/>{' '}
                  ...
                  <>
                    ...
                    <div className="mt-4">
                      <MileageQuickSelect
                        ...
                        ctaLabels={{
                          enterReg: 'Enter your Nissan reg above',
                          selectMileage: 'Select mileage to see your price',
                          submit: 'Get my Nissan quote',
                        }}
                      />
                    </div>
                    ...
                    <div className="md:hidden mt-5 flex justify-center">
                      <img
                        src={nissanHero}
                        alt="Friendly panda mascot with a Nissan — extended warranty cover"
            ...
            <div className="hidden md:block lg:order-last">
              <div className="relative">
                <img src={nissanHero} alt="Friendly panda mascot with a Nissan — extended warranty cover" className="w-full h-auto rounded-2xl" loading="eager" />
              </div>
              <div className="mt-5 flex flex-col items-center gap-3">
                ...
                <p className="text-center text-[12.5px] text-slate-600 leading-snug max-w-xs">
                  ...
                  Not affiliated with Nissan. Flexible cover from 60p a day.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <h2 className="text-3xl md:text-[40px] font-black text-[#0F172A] leading-tight">
                Why Nissan owners choose <span className="text-[#F97316]">Buyawarranty</span>
              </h2>
              <p className="mt-3 text-slate-600 text-[15px] md:text-base">
                Nissan repairs can add up. We help make unexpected costs easier to manage with simple warranty cover and UK-based support.
              </p>
            </div>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              ...
              <p className="text-center text-[13px] text-slate-600 leading-snug max-w-md">
                Independent UK warranty provider. Not affiliated with Nissan.<br />
              ...
              <Button onClick={scrollToQuote} className="mt-2 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Check my Nissan price <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button onClick={scrollToQuote} className="animate-breathing bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Get my Nissan quote <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Nissan models we cover</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Cover available for most Nissan models and engine types, subject to eligibility.</p>
            </div>
              ...
              {nissanModels.map(m => (
                <div key={m.label} className="flex flex-col items-center text-center">
                  <div className="w-full aspect-[4/3] bg-white rounded-xl border border-slate-100 flex items-center justify-center overflow-hidden p-3">
                    <img src={m.img} alt={m.alt} title={m.alt} width={1024} height={768} className="w-full h-full object-contain" loading="lazy" />
                  </div>
            ...
            <div className="text-center mt-6">
              <button onClick={scrollToQuote} className="inline-flex items-center gap-1 text-[#F97316] font-bold text-sm hover:underline">
                View all Nissan models we cover <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-white to-slate-50 border-t border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">What does Nissan warranty cover?</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Eight major systems protected, so you can drive your Nissan with confidence.</p>
            </div>
            ...
            <div className="text-center mt-6">
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                See my Nissan cover options <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-14 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-6">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Additional Nissan cover options</h2>
            </div>
        ...
        <section className="py-12 md:py-16 bg-white border-t border-slate-100">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              ...
              <p className="mt-3 text-sm md:text-base text-slate-600">Got questions before you get a quote? Here are the answers Nissan owners ask us most.</p>
            </div>
                    ...
                    {open && (
                      <div className="mt-2">
                        ...
                        {i === 0 && (
                          ...
                          >
                            Check my Nissan price <ArrowRight className="w-4 h-4" />
                          </button>
                        )}
                      </div>
                    )}
        ...
        <div className="fixed bottom-0 inset-x-0 z-50 md:hidden bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] p-3">
          <div className="flex gap-2">
            ...
            <Button onClick={scrollToQuote} className="flex-1 bg-[#16A34A] hover:bg-[#15803D] text-white font-bold h-12">Get my Nissan quote</Button>
          </div>
        </div>
      </div>
...
export default NissanExtendedWarrantyLanding;
