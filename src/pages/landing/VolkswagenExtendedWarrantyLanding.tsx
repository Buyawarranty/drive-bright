...
import {
  ...
  Headphones, Cog, Thermometer, CircleDot,
  Fuel, User, Globe, LifeBuoy, Home, ClipboardCheck, Info,
} from 'lucide-react';
...
import vwHeroAsset from '@/assets/vw-panda-hero.png.asset.json';
const vwHero = vwHeroAsset.url;
...
const faqs = [
  { q: 'How much does Volkswagen extended warranty cover cost?', a: 'Prices start from £19/month. Your exact price depends on your VW model, age, mileage and the level of cover you choose.' },
  { q: 'What Volkswagen models can you cover?', a: 'We can provide cover for most VW models — Golf, Polo, Passat, Tiguan, T-Roc, Touareg, Transporter, Caddy and the ID. electric range — subject to age, mileage, vehicle condition and eligibility checks. Vehicles up to 15 years old and 150,000 miles are typically eligible.' },
  { q: 'Can I use my own garage?', a: 'Yes, repairs can usually be carried out by any VAT-registered garage of your choice, subject to claim approval and policy terms. You are not restricted to a VW main dealer.' },
  ...
  { q: 'Is Buyawarranty part of Volkswagen?', a: 'No. Buyawarranty is an independent UK warranty provider and is not affiliated with Volkswagen AG or any VW main dealer.' },
...
const VolkswagenExtendedWarrantyLanding: React.FC = () => {
  ...
  const submitToMainJourney = async () => {
    ...
    try {
      ...
      try {
        ...
        if (data?.found) {
          extra = { make: data.make || 'Volkswagen', model: data.model, fuelType: data.fuelType, transmission: data.transmission, year: data.yearOfManufacture, vehicleType: 'car', manufactureDate: data.manufactureDate };
        }
      } catch { /* ok */ }
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-slate-900 pb-24 md:pb-0 font-sans">
        ...
        <header className="sticky top-0 z-40 bg-white border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-xs px-4">Get my VW quote</Button>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_1fr] gap-6 lg:gap-10 items-start">
            ...
            <div>
              <h1 className="text-[28px] sm:text-4xl md:text-5xl lg:text-[52px] font-black text-[#0F172A] leading-[1.05] tracking-tight">
                Volkswagen Extended Warranty Cover<br className="hidden sm:block"/>{' '}
              ...
              <p className="mt-3 md:mt-4 text-slate-700 text-[15px] md:text-base leading-snug">
                Protect your Volkswagen from unexpected repair bills with flexible UK warranty cover. Get an instant quote in under 60 seconds.
              </p>
                  ...
                  <>
                    ...
                    <div className="mt-4">
                      <MileageQuickSelect
                        ...
                        ctaLabels={{
                          enterReg: 'Enter your VW reg above',
                          selectMileage: 'Select mileage to see your price',
                          submit: 'Get my VW quote',
                        }}
                      />
                    </div>
            ...
            <div className="hidden md:block lg:order-last">
              <div className="relative">
                <img src={vwHero} alt="Volkswagen with extended warranty cover" className="w-full h-auto rounded-2xl" loading="eager" />
              </div>
              <div className="mt-5 flex flex-col items-center gap-3">
                ...
                <p className="text-center text-[12.5px] text-slate-600 leading-snug max-w-xs">
                  ...
                  Not affiliated with Volkswagen. Flexible cover from 60p a day.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Why VW owners choose Buyawarranty */}
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <h2 className="text-3xl md:text-[40px] font-black text-[#0F172A] leading-tight">
                Why Volkswagen owners choose <span className="text-[#F97316]">Buyawarranty</span>
              </h2>
              <p className="mt-3 text-slate-600 text-[15px] md:text-base">
                VW repairs — DSG gearboxes, turbochargers and electronics — can be expensive. We help make unexpected costs easier to manage with simple warranty cover and UK-based support.
              </p>
            </div>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              ...
              <p className="text-center text-[13px] text-slate-600 leading-snug max-w-md">
                Independent UK warranty provider. Not affiliated with Volkswagen.<br />
              ...
              <Button onClick={scrollToQuote} className="mt-2 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Check my VW price <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
              ...
              {[
                ...
                <div key={n} className="relative flex flex-col items-center text-center px-2">
                  <div className="relative mb-5">
                    ...
                    <div className={`absolute -right-2 -bottom-1 w-9 h-9 rounded-full ${numBg} text-white flex items-center justify-center font-black text-sm shadow-md ring-4 ring-white`}>{n}</div>
                  </div>
            ...
            <div className="text-center mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button onClick={scrollToQuote} className="animate-breathing bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Get my VW quote <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center mt-6">
              <button onClick={scrollToQuote} className="inline-flex items-center gap-1 text-[#F97316] font-bold text-sm hover:underline">
                View all Volkswagen models we cover <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-white to-slate-50 border-t border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">What does Volkswagen warranty cover?</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Eight major systems protected, so you can drive your VW with confidence.</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
              {[
                { I: Cog,        t: 'Engine',                 bg: 'bg-orange-50',  ring: 'border-orange-200',  ic: 'text-orange-600',  hoverRing: 'hover:border-orange-400' },
                { I: Settings2,  t: 'DSG / Gearbox',          bg: 'bg-blue-50',    ring: 'border-blue-200',    ic: 'text-blue-600',    hoverRing: 'hover:border-blue-400' },
            ...
            <div className="text-center mt-6">
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                See my VW cover options <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-14 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-6">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Additional Volkswagen cover options</h2>
            </div>
        ...
        <section className="py-12 md:py-16 bg-white border-t border-slate-100">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              ...
              <p className="mt-3 text-sm md:text-base text-slate-600">Got questions before you get a quote? Here are the answers Volkswagen owners ask us most.</p>
            </div>
                    ...
                    {open && (
                      <div className="mt-2">
                        ...
                        {i === 0 && (
                          ...
                          >
                            Check my VW price <ArrowRight className="w-4 h-4" />
                          </button>
                        )}
                      </div>
                    )}
        ...
        <div className="fixed bottom-0 inset-x-0 z-50 md:hidden bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] p-3">
          <div className="flex gap-2">
            ...
            <Button onClick={scrollToQuote} className="flex-1 bg-[#16A34A] hover:bg-[#15803D] text-white font-bold h-12">Get my VW quote</Button>
          </div>
        </div>
      </div>
...
export default VolkswagenExtendedWarrantyLanding;
