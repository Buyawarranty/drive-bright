...
import audiHeroAsset from '@/assets/audi-hero-panda-cars.png.asset.json';
const audiHero = audiHeroAsset.url;
...
import audiQ3 from '@/assets/audi-models/audi-q3-extended-warranty.jpg';
...
const audiModels = [
  ...
  { label: 'A3', examples: 'TFSI, TDI, Sportback', img: audiA3, alt: 'Audi A3 extended warranty cover — TFSI petrol, TDI diesel and Sportback hatchback' },
  { label: 'A4', examples: 'Saloon, Avant, TDI', img: audiA4, alt: 'Audi A4 extended warranty cover — saloon, Avant estate and TDI diesel' },
  { label: 'Q3', examples: 'Compact SUV', img: audiQ3, alt: 'Audi Q3 compact SUV extended warranty cover — petrol and diesel' },
  { label: 'Q5', examples: 'Mid-size SUV, TFSI e PHEV', img: audiQ5, alt: 'Audi Q5 mid-size SUV extended warranty cover — petrol, diesel and TFSI e plug-in hybrid' },
  { label: 'Q4 e-tron (EV)', examples: 'Electric SUV', img: audiQ4Etron, alt: 'Audi Q4 e-tron electric SUV extended warranty cover' },
];
...
const faqs = [
  { q: 'How much does Audi extended warranty cover cost?', a: 'Prices start from £19/month. Your exact price depends on your Audi model, age, mileage and the level of cover you choose.' },
  { q: 'What Audi models can you cover?', a: 'We can provide cover for many Audi models — including the A1, A3, A4, A5, A6, Q2, Q3, Q5, Q7, TT and Q4 e-tron — subject to age, mileage, vehicle condition and eligibility checks. Vehicles up to 15 years old and 150,000 miles are typically eligible. High-performance Audi R8, RS and e-tron GT models are not eligible.' },
  ...
  { q: 'Is Buyawarranty part of Audi?', a: 'No. Buyawarranty is an independent UK warranty provider and is not affiliated with Audi AG or the Volkswagen Group.' },
...
const AudiExtendedWarrantyLanding: React.FC = () => {
  ...
  const submitToMainJourney = async () => {
    ...
    try {
      ...
      try {
        ...
        if (data?.found) {
          extra = { make: data.make || 'AUDI', model: data.model, fuelType: data.fuelType, transmission: data.transmission, year: data.yearOfManufacture, vehicleType: 'car', manufactureDate: data.manufactureDate };
        }
      } catch { /* ok */ }
  ...
  return (
    <>
      <SEOHead
        title="Audi Extended Warranty Cover from £19/month | Quote"
        description="Protect your Audi from unexpected repair bills with flexible UK warranty cover from £19/month. Instant online quote in under 60 seconds."
        keywords="Audi extended warranty, Audi warranty quote, Audi warranty UK, used Audi warranty, Audi repair cover, Audi warranty cost, Audi A3 warranty, Audi A4 warranty, Audi Q5 warranty, Audi Q4 e-tron warranty"
        canonical="https://buyawarranty.co.uk/car-extended-warranty/audi/"
        ogImage={`https://buyawarranty.co.uk${audiHero}`}
        ogImageAlt="Audi Extended Warranty Cover from £19/month"
      ...
      <ProductSchema name="Audi Extended Warranty" description="Flexible Audi warranty cover" price="19" brand="BuyaWarranty" category="Vehicle Warranty" image="https://buyawarranty.co.uk/logo.png" availability="https://schema.org/InStock" areaServed="GB" />
      ...
      <div className="min-h-screen bg-white text-slate-900 pb-24 md:pb-0 font-sans">
        ...
        <header className="sticky top-0 z-40 bg-white border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-xs px-4">Get my Audi quote</Button>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_1fr] gap-6 lg:gap-10 items-start">
            <div>
              <h1 className="text-[28px] sm:text-4xl md:text-5xl lg:text-[52px] font-black text-[#0F172A] leading-[1.05] tracking-tight">
                Audi Extended Warranty Cover<br className="hidden sm:block"/>{' '}
                  ...
                  <>
                    ...
                    <div className="mt-4">
                      <MileageQuickSelect
                        ...
                        ctaLabels={{
                          enterReg: 'Enter your Audi reg above',
                          selectMileage: 'Select mileage to see your price',
                          submit: 'Get my Audi quote',
                        }}
                      />
                    </div>
                    ...
                    <div className="md:hidden mt-5 flex justify-center">
                      <img
                        src={audiHero}
                        alt="Friendly panda mascot with an Audi — extended warranty cover"
            ...
            <div className="hidden md:block lg:order-last">
              <div className="relative">
                <img src={audiHero} alt="Friendly panda mascot with an Audi — extended warranty cover" className="w-full h-auto rounded-2xl" loading="eager" />
              </div>
              <div className="mt-5 flex flex-col items-center gap-3">
                ...
                <p className="text-center text-[12.5px] text-slate-600 leading-snug max-w-xs">
                  ...
                  Not affiliated with Audi. Flexible cover from 60p a day.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <h2 className="text-3xl md:text-[40px] font-black text-[#0F172A] leading-tight">
                Why Audi owners choose <span className="text-[#F97316]">Buyawarranty</span>
              </h2>
              <p className="mt-3 text-slate-600 text-[15px] md:text-base">
                Audi repairs can add up. We help make unexpected costs easier to manage with simple warranty cover and UK-based support.
              </p>
            </div>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              ...
              <p className="text-center text-[13px] text-slate-600 leading-snug max-w-md">
                Independent UK warranty provider. Not affiliated with Audi.<br />
              ...
              <Button onClick={scrollToQuote} className="mt-2 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Check my Audi price <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button onClick={scrollToQuote} className="animate-breathing bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Get my Audi quote <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Audi models we cover</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Cover available for most Audi models and engine types, subject to eligibility. (Audi R8, RS and e-tron GT are not eligible.)</p>
            </div>
            ...
            <div className="text-center mt-6">
              <button onClick={scrollToQuote} className="inline-flex items-center gap-1 text-[#F97316] font-bold text-sm hover:underline">
                View all Audi models we cover <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-white to-slate-50 border-t border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">What does Audi warranty cover?</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Eight major systems protected, so you can drive your Audi with confidence.</p>
            </div>
            ...
            <div className="text-center mt-6">
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                See my Audi cover options <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-14 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-6">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Additional Audi cover options</h2>
            </div>
        ...
        <section className="py-12 md:py-16 bg-white border-t border-slate-100">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              ...
              <p className="mt-3 text-sm md:text-base text-slate-600">Got questions before you get a quote? Here are the answers Audi owners ask us most.</p>
            </div>
                    ...
                    {open && (
                      <div className="mt-2">
                        ...
                        {i === 0 && (
                          ...
                          >
                            Check my Audi price <ArrowRight className="w-4 h-4" />
                          </button>
                        )}
                      </div>
                    )}
        ...
        <div className="fixed bottom-0 inset-x-0 z-50 md:hidden bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] p-3">
          <div className="flex gap-2">
            ...
            <Button onClick={scrollToQuote} className="flex-1 bg-[#16A34A] hover:bg-[#15803D] text-white font-bold h-12">Get my Audi quote</Button>
          </div>
        </div>
      </div>
...
export default AudiExtendedWarrantyLanding;
