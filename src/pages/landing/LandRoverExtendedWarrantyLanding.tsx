...
import lrHeroAsset from '@/assets/land-rover-panda-hero.png.asset.json';
...
import rangeRoverEvoque from '@/assets/landrover-models/range-rover-evoque-extended-warranty.jpg';
...
const landRoverModels = [
  ...
  { label: 'Range Rover Sport', examples: 'P400, P440e PHEV, D300', img: rangeRoverSport, alt: 'Range Rover Sport extended warranty cover — P400, P440e PHEV, D300 performance SUV' },
  { label: 'Range Rover Velar', examples: 'P250, P400, D200', img: rangeRoverVelar, alt: 'Range Rover Velar extended warranty cover — P250, P400, D200 mid-size SUV' },
  { label: 'Range Rover Evoque', examples: 'P200, P300e PHEV, D165', img: rangeRoverEvoque, alt: 'Range Rover Evoque extended warranty cover — P200, P300e PHEV compact SUV' },
  { label: 'Defender (90 / 110 / 130)', examples: 'P300, P400, D250, V8', img: landRoverDefender, alt: 'Land Rover Defender 90, 110 and 130 extended warranty cover — P300, P400, D250, V8 off-road SUV' },
  { label: 'Discovery / Discovery Sport / Freelander', examples: 'P300, D250, R-Dynamic', img: landRoverDiscovery, alt: 'Land Rover Discovery, Discovery Sport and Freelander extended warranty cover' },
];
...
const faqs = [
  { q: 'How much does Land Rover extended warranty cover cost?', a: 'Prices start from £19/month. Your exact price depends on your Land Rover or Range Rover model, age, mileage and the level of cover you choose. Larger Range Rover, Sport and Defender models may attract a premium.' },
  { q: 'What Land Rover and Range Rover models can you cover?', a: 'We can provide cover for many Land Rover and Range Rover models, subject to age, mileage, vehicle condition and eligibility checks. This includes Range Rover, Range Rover Sport, Velar, Evoque, Defender (90, 110, 130), Discovery, Discovery Sport and Freelander. Vehicles up to 15 years old and 150,000 miles are typically eligible.' },
  { q: 'Can I use my own garage?', a: 'Yes, repairs can usually be carried out by a VAT-registered garage of your choice — including Land Rover and Range Rover specialists — subject to claim approval and policy terms.' },
  ...
  { q: 'Is Buyawarranty part of Land Rover or JLR?', a: 'No. Buyawarranty is an independent UK warranty provider and is not affiliated with Land Rover, Range Rover or Jaguar Land Rover.' },
...
const LandRoverExtendedWarrantyLanding: React.FC = () => {
  ...
  const scrollToQuote = () => {
    trackButtonClick('landrover_ppc_cta');
  ...
  const submitToMainJourney = async () => {
    ...
    try {
      ...
      try {
        ...
        if (data?.found) {
          extra = { make: data.make || 'LAND ROVER', model: data.model, fuelType: data.fuelType, transmission: data.transmission, year: data.yearOfManufacture, vehicleType: 'car', manufactureDate: data.manufactureDate };
        }
      } catch { /* ok */ }
    ...
    <>
      ...
      <div className="min-h-screen bg-white text-slate-900 pb-24 md:pb-0 font-sans">
        ...
        <header className="sticky top-0 z-40 bg-white border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-xs px-4">Get my Land Rover quote</Button>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_1fr] gap-6 lg:gap-10 items-start">
            <div>
              ...
              <p className="mt-3 md:mt-4 text-slate-700 text-[15px] md:text-base leading-snug">
                Flexible UK warranty cover for every Land Rover and Range Rover. Instant quote in 60 seconds.
              </p>
                  ...
                  <>
                    <div className="relative">
                      <div className="flex items-stretch rounded-lg overflow-hidden shadow-lg border-2 border-black w-full">
                        ...
                        <input
                          ...
                          placeholder="ENTER LAND ROVER REG"
                    ...
                    <div className="mt-4">
                      <MileageQuickSelect
                        ...
                        ctaLabels={{
                          enterReg: 'Enter your Land Rover reg above',
                          selectMileage: 'Select mileage to see your price',
                          submit: 'Get my Land Rover quote',
                        }}
                      />
                    </div>
            ...
            <div className="hidden md:block lg:order-last">
              ...
              <div className="mt-5 flex flex-col items-center gap-3">
                ...
                <p className="text-center text-[12.5px] text-slate-600 leading-snug max-w-xs">
                  ...
                  Not affiliated with Land Rover or JLR. Flexible cover from 60p a day.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <h2 className="text-3xl md:text-[40px] font-black text-[#0F172A] leading-tight">
                Why Land Rover &amp; Range Rover owners choose <span className="text-[#F97316]">Buyawarranty</span>
              </h2>
              <p className="mt-3 text-slate-600 text-[15px] md:text-base">
                Land Rover and Range Rover repairs — from air suspension to driveline — can be expensive. We help make unexpected costs easier to manage with simple warranty cover and UK-based support.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-5 md:gap-6">
              {[
                ...
                { I: Wrench, badge: 'More choice', badgeBg: 'bg-[#E7F8EF] text-[#16A34A]', iconBg: 'bg-[#DCFCE7]', iconColor: 'text-[#16A34A]', topBar: 'bg-[#16A34A]', t: 'Use your own trusted garage', d: 'Repairs can be carried out by a VAT-registered garage or Land Rover specialist, subject to claim approval.' },
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              ...
              <p className="text-center text-[13px] text-slate-600 leading-snug max-w-md">
                Independent UK warranty provider. Not affiliated with Land Rover or Jaguar Land Rover.<br />
              ...
              <Button onClick={scrollToQuote} className="mt-2 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Check my Land Rover price <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button onClick={scrollToQuote} className="animate-breathing bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                Get my Land Rover quote <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Land Rover &amp; Range Rover models we cover</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Cover available for most Land Rover and Range Rover models, including petrol, diesel, PHEV and V8, subject to eligibility.</p>
            </div>
            ...
            <div className="text-center mt-6">
              <button onClick={scrollToQuote} className="inline-flex items-center gap-1 text-[#F97316] font-bold text-sm hover:underline">
                View all Land Rover models we cover <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-white to-slate-50 border-t border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">What does Land Rover warranty cover?</h2>
              <p className="mt-2 text-slate-600 text-sm md:text-base">Eight major systems protected, so you can drive your Land Rover or Range Rover with confidence.</p>
            </div>
            ...
            <div className="text-center mt-6">
              <Button onClick={scrollToQuote} className="bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-base px-8 py-3 h-auto min-h-[52px] inline-flex items-center justify-center rounded-md shadow-md">
                See my Land Rover cover options <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-14 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-6">
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Additional Land Rover cover options</h2>
            </div>
        ...
        <section className="py-12 md:py-16 bg-white border-t border-slate-100">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8">
              ...
              <p className="mt-3 text-sm md:text-base text-slate-600">Got questions before you get a quote? Here are the answers Land Rover and Range Rover owners ask us most.</p>
            </div>
                    ...
                    {open && (
                      <div className="mt-2">
                        ...
                        {i === 0 && (
                          ...
                          >
                            Check my Land Rover price <ArrowRight className="w-4 h-4" />
                          </button>
                        )}
                      </div>
                    )}
        ...
        <div className="fixed bottom-0 inset-x-0 z-50 md:hidden bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] p-3">
          <div className="flex gap-2">
            ...
            <Button onClick={scrollToQuote} className="flex-1 bg-[#16A34A] hover:bg-[#15803D] text-white font-bold h-12">Get my Land Rover quote</Button>
          </div>
        </div>
      </div>
...
export default LandRoverExtendedWarrantyLanding;
