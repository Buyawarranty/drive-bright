  ...
  return (
    <>
      <SEOHead
        ...
        ogImage={`https://buyawarranty.co.uk${bmwHero}`}
        ogImageAlt="BMW Extended Warranty Cover from £19/month"
                ...
                {step === 1 && (
                  <>
                    ...
                    <div className="md:hidden mt-5 flex justify-center">
                      <img
                        src={bmwHero}
                        alt="Premium BMW with extended warranty cover"
                    ...
                    {open && (
                      <div className="mt-2">
                        ...
                        {i === 0 && (
                          ...
                          >
                            Check my BMW price <ArrowRight className="w-4 h-4" />
                          </button>
                        )}
                      </div>
                    )}
