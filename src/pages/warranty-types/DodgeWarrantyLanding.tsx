...
import heroImage from '@/assets/dodge-extended-warranty-uk.png';
...
const startingPrice = '29';

const modelCategories = {
  'Muscle Cars': { 'Charger': ['LD', 'LX'], 'Challenger': ['LC'] },
  'SUVs': { 'Durango': ['WD', 'WK'], 'Nitro': ['KA'], 'Journey': ['JC'] },
  'Pickup': { 'Ram 1500': ['DS', 'DT'], 'Ram 2500': ['DJ'] },
};

type ModelCategory = keyof typeof modelCategories;

const faqs = [
  { question: "Is a Dodge extended warranty worth it in the UK?", answer: "Absolutely. Dodge vehicles use American-spec components that can be expensive to source and repair in the UK. A HEMI engine rebuild or transmission failure can cost £4,000–£10,000." },
  { question: "How much does a Dodge extended warranty cost?", answer: `Dodge warranty prices start from £${startingPrice}/month depending on model, mileage, and claim limit.` },
  ...
  { question: "Are HEMI engines covered?", answer: "Yes, all HEMI V8 engines are fully covered including pistons, valves, timing components, and the MDS cylinder deactivation system." },
  { question: "Is the automatic transmission covered?", answer: "Yes, the ZF 8-speed and other Dodge transmissions are covered including torque converter, valve body, and electronic controls." },
...
const testimonials = [
  { name: "Mike T.", location: "Essex", model: "Dodge Charger", text: "Transmission issue covered completely — £3,800 claim paid fast. Essential for any US import owner.", rating: 5 },
  { name: "Chris D.", location: "Birmingham", model: "Dodge Ram", text: "HEMI engine sensor failure sorted. Great to have UK-based support for my American truck.", rating: 5 },
  { name: "Steve L.", location: "Kent", model: "Dodge Challenger", text: "Rear diff rebuilt under warranty. Would have been £2,500 out of pocket. Brilliant cover.", rating: 5 },
  { name: "Paul W.", location: "Manchester", model: "Dodge Durango", text: "Air conditioning compressor replaced. Fast claim, no hassle. Highly recommend for Dodge owners.", rating: 5 }
];

const repairs = [
  { name: 'HEMI Engine Rebuild', cost: '£4,000 – £10,000', icon: Wrench, severity: 'critical' as const },
  { name: 'Automatic Transmission', cost: '£3,000 – £6,000', icon: Car, severity: 'critical' as const },
  { name: 'Transfer Case (4WD)', cost: '£1,500 – £3,500', icon: Truck, severity: 'high' as const },
  { name: 'Rear Differential', cost: '£1,200 – £2,800', icon: Wrench, severity: 'high' as const },
  { name: 'Fuel Injector Set', cost: '£1,000 – £2,500', icon: Zap, severity: 'medium' as const },
  { name: 'ECU Replacement', cost: '£1,200 – £3,000', icon: Zap, severity: 'high' as const },
  { name: 'Supercharger Rebuild', cost: '£2,500 – £5,000', icon: Zap, severity: 'critical' as const },
  { name: 'Power Steering Rack', cost: '£1,000 – £2,200', icon: Wrench, severity: 'medium' as const },
  { name: 'Air Suspension', cost: '£1,500 – £3,000', icon: Car, severity: 'high' as const },
];

const DodgeWarrantyLanding: React.FC = () => {
              ...
              <div className="relative">
                ...
                <div className="flex flex-col items-center gap-4 mt-6">
                  <div className="flex items-center justify-center gap-3 sm:gap-4 lg:gap-6 flex-wrap">
                    <div className="flex items-center space-x-1.5"><Car className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">Muscle Cars</span></div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">American muscle requires specialist UK parts — repairs can be very expensive.</p>
            </div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[{ icon: Shield, title: 'Comprehensive Cover', desc: 'HEMI, transmission, electrics & more' }, { icon: MapPin, title: 'Any UK Garage', desc: 'Any VAT-registered garage' }, { icon: Phone, title: 'UK Claims Team', desc: 'Fast, hassle-free claims' }, { icon: Clock, title: 'Instant Cover', desc: 'Protection starts immediately' }].map((item, i) => (
...
export default DodgeWarrantyLanding;
