...
import heroImage from '@/assets/mini-extended-warranty-uk.png';
...
const modelCategories = {
  'Hatchbacks': { 'Cooper': ['F56', 'F55'], 'Cooper S': ['F56', 'F55'], 'John Cooper Works': ['F56'] },
  'Convertibles': { 'Convertible': ['F57'], 'Cooper S Convertible': ['F57'] },
  'SUVs & Crossovers': { 'Countryman': ['F60', 'U25'], 'Paceman': ['R61'] },
  'Estate': { 'Clubman': ['F54'] },
};
...
const faqs = [
  { question: "Is a MINI extended warranty worth it?", answer: "Yes. MINIs share BMW engineering which means specialist parts and labour costs. A timing chain or turbo failure can cost £1,500–£4,000. Our warranty protects you from unexpected bills." },
  { question: "How much does a MINI extended warranty cost?", answer: `MINI warranty prices start from £${startingPrice}/month depending on model, mileage, and claim limit. Flexible monthly or annual payments available.` },
  { question: "Can I get cover after my MINI dealer warranty expires?", answer: "Yes, we cover vehicles up to 150,000 miles and 15 years old, even after manufacturer warranty has expired." },
  { question: "Can I use my own garage?", answer: "Yes, any VAT-registered garage in the UK, including MINI specialists and independent garages." },
  { question: "Is the MINI Electric covered?", answer: "Yes, our comprehensive plan covers electric components including the electric motor, battery management system, and power electronics." },
  { question: "Are turbo models covered?", answer: "Yes, all turbocharged MINI models are fully covered including the turbocharger, intercooler, and boost control systems." },
...
const testimonials = [
  { name: "Sarah K.", location: "Bristol", model: "MINI Cooper S", text: "Turbo replacement covered in full — would have been £2,800 out of pocket. Brilliant service!", rating: 5 },
  { name: "Tom H.", location: "Manchester", model: "MINI Countryman", text: "Timing chain issue sorted quickly. £1,900 claim paid without any fuss. Highly recommend.", rating: 5 },
  { name: "Lucy P.", location: "London", model: "MINI Cooper", text: "Clutch actuator failed — fully covered. The claims process was so easy. Worth every penny.", rating: 5 },
  { name: "David R.", location: "Edinburgh", model: "MINI Clubman", text: "Power steering pump went on my Clubman. Covered completely. Great peace of mind.", rating: 5 }
];

const repairs = [
  { name: 'Timing Chain Replacement', cost: '£1,500 – £3,500', icon: Wrench, severity: 'critical' as const },
  { name: 'Turbocharger Replacement', cost: '£1,800 – £3,200', icon: Zap, severity: 'critical' as const },
  { name: 'Clutch & DMF Replacement', cost: '£1,200 – £2,500', icon: Wrench, severity: 'high' as const },
  { name: 'Power Steering Pump', cost: '£800 – £1,800', icon: Car, severity: 'high' as const },
  { name: 'Water Pump Failure', cost: '£600 – £1,200', icon: Wrench, severity: 'medium' as const },
  { name: 'ECU Replacement', cost: '£900 – £2,000', icon: Zap, severity: 'high' as const },
  { name: 'Fuel Injector Set', cost: '£800 – £1,600', icon: Zap, severity: 'medium' as const },
  { name: 'EV Battery Module', cost: '£2,000 – £5,000', icon: Battery, severity: 'critical' as const },
  { name: 'Gearbox Repair', cost: '£1,500 – £3,000', icon: Wrench, severity: 'high' as const },
];

const MiniWarrantyLanding: React.FC = () => {
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <div className="mx-auto lg:mx-0 space-y-4">
                  ...
                  <p className="text-xs text-gray-500 mt-3 text-center lg:text-left">{brandName} is a registered trademark of BMW AG. We are an independent warranty provider.</p>
                  <TrustCallbackPanel />
                </div>
              </div>
              <div className="relative">
                ...
                <div className="flex flex-col items-center gap-4 mt-6">
                  <div className="flex items-center justify-center gap-3 sm:gap-4 lg:gap-6 flex-wrap">
                    <div className="flex items-center space-x-1.5"><Car className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">Hatchbacks</span></div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">MINI shares BMW engineering — repairs can be surprisingly expensive.</p>
            </div>
            ...
            <div className="mt-8 md:mt-12 text-center">
              <div className="bg-brand-deep-blue rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-4">
                  <div className="text-center"><p className="text-xs md:text-sm font-semibold text-white/60 uppercase tracking-wider mb-1">Typical repair</p><p className="text-2xl md:text-4xl font-bold text-red-400 line-through decoration-2">£2,500</p></div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-center md:text-left">
                ...
                <ul className="space-y-2 text-left max-w-md mx-auto md:mx-0">
                  {['Use any VAT-registered garage', 'MINI specialist or independent', 'Recovery to nearest garage', 'UK-based claims team'].map((item, i) => (<li key={i} className="flex items-center gap-2"><Check className="w-5 h-5 text-green-400 flex-shrink-0" /><span>{item}</span></li>))}
                </ul>
              </div>
...
export default MiniWarrantyLanding;
