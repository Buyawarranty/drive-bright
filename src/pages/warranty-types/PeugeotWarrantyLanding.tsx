          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              ...
              <div className="relative">
                <div className="relative">
                  <OptimizedImage src={peugeot3008Hero} alt="Peugeot 3008 front view - Peugeot extended warranty UK coverage" className="w-full max-w-[35%] mx-auto h-auto" priority width={651} height={500} />
