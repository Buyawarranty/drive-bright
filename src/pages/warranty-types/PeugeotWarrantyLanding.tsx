  ...
  return (
    <>
      ...
      <main itemScope itemType="https://schema.org/WebPage">
        <section id="hero-section" className="relative bg-gradient-to-br from-blue-50 via-white to-gray-50 pt-6 pb-10 md:pt-10 md:pb-16 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-5">
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium"><Shield className="h-4 w-4" /> Official Peugeot Extended Warranty Partner</div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 leading-tight">Peugeot Extended <span className="text-brand-orange">Warranty</span> UK</h1>
              <p className="text-base md:text-lg text-gray-600 max-w-xl">Protect your Peugeot with comprehensive cover from just <strong>£20/month</strong>. All models from 2012 to 2026 including 208, 308, 3008, 5008, 508, e-208 & e-2008. PureTech & EAT8 covered. Use any UK garage.</p>
              ...
              <TrustCallbackPanel />
              <div className="flex items-center gap-3"><OptimizedImage src={trustpilotExcellent} alt="Trustpilot Excellent Rating" className="h-10" width={120} height={40} /><span className="text-sm text-gray-600">Rated <strong>Excellent</strong> by Peugeot owners</span></div>
            </div>
            <div className="relative hidden lg:flex flex-col items-center justify-center">
              <div className="relative flex items-end justify-center gap-4"><OptimizedImage src={peugeot3008Hero} alt="Peugeot 3008 extended warranty UK" className="max-w-[35%] h-auto drop-shadow-2xl" priority width={269} height={179} /><OptimizedImage src={pandaThumbsUp} alt="Buy A Warranty mascot" className="max-w-[25%] h-auto" priority width={192} height={192} /><OptimizedImage src={peugeot208Warranty} alt="Peugeot 208 used car warranty UK" className="max-w-[35%] h-auto drop-shadow-2xl" priority width={269} height={179} /></div>
              <div className="mt-6 flex items-center gap-2"><div className="flex -space-x-1">{[...Array(5)].map((_, i) => <Star key={i} className="h-5 w-5 fill-yellow-400 text-yellow-400" />)}</div><span className="text-sm font-medium text-gray-700">Trusted by thousands of Peugeot owners</span></div>
            </div>
          </div></div>
        </section>
