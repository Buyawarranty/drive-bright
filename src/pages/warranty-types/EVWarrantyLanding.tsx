...
const evFAQs = [
  ...
  },
  {
    ...
    answer: "Warranty costs start from just £29 per month for electric vehicles, depending on your vehicle and the level of cover you choose. Get an instant quote by entering your registration number above."
  },
  {
...
const EVWarrantyLanding: React.FC = () => {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Electric vehicle warranty", "item": "https://buyawarranty.co.uk/warranty-types/ev/" }
    ]
  };
        ...
        <section className="py-12 md:py-20 bg-brand-orange">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-6 md:mb-8 max-w-2xl mx-auto">
              Get an instant quote in 60 seconds. Comprehensive EV cover from just £29/month.
            </p>
