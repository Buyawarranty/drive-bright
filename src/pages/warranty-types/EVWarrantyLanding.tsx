...
const EVWarrantyLanding: React.FC = () => {
  ...
  const serviceSchema = {
    ...
    "offers": { "@type": "Offer", "priceCurrency": "GBP", "price": "19", "availability": "https://schema.org/InStock", "url": "https://buyawarranty.co.uk/warranty-types/ev/" },
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
            ...
            <div className="mt-8 md:mt-12 text-center">
              <div className="bg-[#1a2e5a] rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
                <h3 className="text-xl md:text-2xl font-bold text-white mb-2">
                  EV warranty cover from just £19/month
                </h3>
