...
const brandMake = 'Smart';
const startingPrice = '19';

const modelCategories = {
  'City Cars': {
    'ForTwo': ['W450', 'W451', 'W453'],
    'ForFour': ['W454', 'W453'],
    'ForTwo Cabrio': ['W451', 'W453'],
  },
  'Electric': {
    'EQ ForTwo': ['W453 EQ'],
    'EQ ForFour': ['W453 EQ'],
...
const coverageCategories = [
  {
    ...
    icon: Car,
    items: ['Engine block and cylinder head', 'Pistons, rings, and bearings', 'Crankshaft and camshaft', 'Timing chains and tensioners', 'Oil pump and oil cooler', 'Turbocharger/supercharger', 'Intake and exhaust manifolds']
  },
  {
    title: 'Transmission & Drivetrain',
    icon: Wrench,
    items: ['Automated manual gearbox', 'Dual-clutch transmission', 'Torque converter', 'Drive shafts and CV joints', 'Differential', 'Clutch actuator', 'Gear selector mechanism']
  },
  {
    title: 'Electrical & Electronics',
    icon: Zap,
    items: ['ECU and control modules', 'Infotainment system', 'Digital instrument cluster', 'Parking sensors and cameras', 'Electric window motors', 'Central locking system', 'Starter motor and alternator']
  },
  {
    title: 'Cooling & Fuel Systems',
    icon: Shield,
    items: ['Water pump and thermostat', 'Radiator and expansion tank', 'Fuel pump and injectors', 'Fuel rail and regulator', 'EGR valve and cooler', 'Oil/coolant heat exchangers', 'Intercooler']
  },
  {
    title: 'Suspension & Steering',
    icon: Car,
    items: ['Power steering pump/rack', 'Electric power steering motor', 'Shock absorbers and struts', 'Control arms and bushings', 'Anti-roll bar links', 'Wheel bearings and hubs', 'Steering column']
  },
  {
    title: 'Electric Vehicle Components',
    icon: Zap,
    items: ['Electric drive motor', 'Power electronics module', 'DC-DC converter', 'On-board charger', 'Battery management system', 'Regenerative braking system', 'Thermal management system']
  },
];

const faqs = [
  { question: `Is a ${brandName} extended warranty worth it in the UK?`, answer: `Yes, ${brandName} cars use specialist components that can be expensive to repair. Our extended warranty protects key components like the engine, gearbox, electrics, and more, preventing sudden repair bills.` },
  ...
  { question: `Does the warranty cover electric ${brandName} models?`, answer: `Yes, our comprehensive plan covers electric and hybrid components including the electric motor, battery management system, power electronics, and thermal management systems.` },
...
const repairs = [
  { name: 'Gearbox Actuator', cost: '£800 – £1,500', icon: Wrench, severity: 'high' },
  { name: 'Turbocharger Replacement', cost: '£1,200 – £2,500', icon: Zap, severity: 'high' },
  { name: 'Engine Rebuild', cost: '£2,000 – £4,000', icon: Car, severity: 'critical' },
  { name: 'ECU Replacement', cost: '£600 – £1,500', icon: Zap, severity: 'medium' },
  { name: 'Clutch Actuator', cost: '£500 – £1,200', icon: Wrench, severity: 'medium' },
  { name: 'Power Steering Motor', cost: '£400 – £900', icon: Car, severity: 'medium' },
...
const SmartWarrantyLanding: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Smart Extended Warranty UK: Affordable Car Protection Plans</title>
        <meta name="description" content="Discover Smart extended warranty plans that help reduce repair costs and ensure reliable protection for compact vehicles." />
        ...
        <meta property="og:description" content="Discover Smart extended warranty plans that help reduce repair costs and ensure reliable protection for compact vehicles." />
      ...
      <main className="min-h-screen bg-white" role="main">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <div className="mx-auto lg:mx-0 space-y-4">
                  ...
                  <p className="text-xs text-gray-500 mt-3 text-center lg:text-left">{brandName} is a registered trademark of Mercedes-Benz Group AG. We are an independent warranty provider.</p>
                  <TrustCallbackPanel />
                </div>
              </div>
              <div className="relative">
                <OptimizedImage src={smartHeroImage} alt={`${brandName} extended warranty UK - Professional ${brandName} warranty coverage`} className="w-full h-auto" priority={true} width={651} height={434} />
        ...
        <RelatedInternalLinks
          links={[
            { to: '/warranty-types/ssangyong-warranty/', label: 'ssangyong extended warranty' },
...
export default SmartWarrantyLanding;
