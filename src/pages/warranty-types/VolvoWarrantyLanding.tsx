...
const VolvoWarrantyLanding: React.FC = () => {
  ...
  const productSchema = { "@context": "https://schema.org", "@type": "Product",
      "image": ["https://buyawarranty.co.uk/extended_warranty_uk-car-trustworthy-reviews.png"], "name": "Volvo Extended Warranty UK", "description": "Comprehensive extended warranty for Volvo models including XC40, XC60, XC90, S60, V60, V90, S90, XC40 Recharge, C40 Recharge, EX30, EX90. T8 hybrid, AWD, air suspension, EV components covered.", "brand": { "@type": "Brand", "name": "Buy A Warranty" }, "offers": { "@type": "Offer", "priceCurrency": "GBP", "price": String(SEO_FROM_MONTHLY_PRICE), "availability": "https://schema.org/InStock", "url": "https://buyawarranty.co.uk/warranty-types/volvo-warranty/", "priceValidUntil": new Date(Date.now() + 30*24*60*60*1000).toISOString().split('T')[0] }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": TRUSTPILOT_RATING_VALUE, "reviewCount": TRUSTPILOT_REVIEW_COUNT, "bestRating": "5" }, "category": "Vehicle Extended Warranty" };
  const webPageSchema = { "@context": "https://schema.org", "@type": "WebPage", "name": "Volvo Extended Warranty UK | Buy A Warranty", "description": "Comprehensive Volvo extended warranty from £25/month covering XC40, XC60, XC90 and all models. AWD, T8 hybrid & air suspension covered.", "url": "https://buyawarranty.co.uk/warranty-types/volvo-warranty/", "lastReviewed": new Date().toISOString().split('T')[0], "reviewedBy": { "@type": "Organization", "name": "Buy A Warranty" }, "speakable": { "@type": "SpeakableSpecification", "cssSelector": ["h1", "h2", ".faq-question"] }, "publisher": { "@type": "Organization", "name": "Buy A Warranty", "legalName": "BUY A WARRANTY LIMITED", "url": "https://buyawarranty.co.uk" } };
  const localBusinessSchema = { "@context": "https://schema.org", "@type": "LocalBusiness", "address": { "@type": "PostalAddress", "streetAddress": "Warranty House, 62 Berkhamsted Avenue", "addressLocality": "Wembley", "addressRegion": "London", "postalCode": "HA9 6DT", "addressCountry": "GB" }, "name": "Buy A Warranty", "description": "UK's trusted Volvo extended warranty provider since 2016.", "url": "https://buyawarranty.co.uk", "telephone": "03302295040", "foundingDate": "2016", "areaServed": { "@type": "Country", "name": "United Kingdom" }, "priceRange": SEO_PRICE_RANGE, "aggregateRating": { "@type": "AggregateRating", "ratingValue": TRUSTPILOT_RATING_VALUE, "reviewCount": TRUSTPILOT_REVIEW_COUNT, "bestRating": "5" } };
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <a href="https://uk.trustpilot.com/review/buyawarranty.co.uk" target="_blank" rel="noopener noreferrer" title="Buy A Warranty Trustpilot reviews — rated Excellent by UK drivers" aria-label="Read Buy A Warranty reviews on Trustpilot" className="hover:opacity-80 transition-opacity">
