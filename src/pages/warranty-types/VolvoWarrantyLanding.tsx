...
const testimonials = [
  ...
  { name: "Ian D.", location: "Cambridge", model: "XC40 Recharge", text: "Finding EV warranty cover for my XC40 Recharge was difficult until I found Buy A Warranty. **They cover the motor, inverter and all the key EV bits.**", rating: 5 },
...
const VolvoWarrantyLanding: React.FC = () => {
  ...
  const productSchema = { "@context": "https://schema.org", "@type": "Product", "name": "Volvo Extended Warranty UK", "description": "Comprehensive extended warranty for Volvo models including XC40, XC60, XC90, S60, V60, V90, S90, XC40 Recharge, C40 Recharge, EX30, EX90. T8 hybrid, AWD, air suspension, EV components covered.", "brand": { "@type": "Brand", "name": "Buy A Warranty" }, "offers": { "@type": "Offer", "priceCurrency": "GBP", "price": "25", "availability": "https://schema.org/InStock", "url": "https://buyawarranty.co.uk/warranty-types/volvo/", "priceValidUntil": new Date(Date.now() + 30*24*60*60*1000).toISOString().split('T')[0] }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "2847", "bestRating": "5" }, "category": "Vehicle Extended Warranty" };
  const webPageSchema = { "@context": "https://schema.org", "@type": "WebPage", "name": "Volvo Extended Warranty UK | Buy A Warranty", "description": "Comprehensive Volvo extended warranty from £25/month covering XC40, XC60, XC90 and all models. AWD, T8 hybrid & air suspension covered.", "url": "https://buyawarranty.co.uk/warranty-types/volvo/", "lastReviewed": new Date().toISOString().split('T')[0], "reviewedBy": { "@type": "Organization", "name": "Buy A Warranty" }, "speakable": { "@type": "SpeakableSpecification", "cssSelector": ["h1", "h2", ".faq-question"] }, "publisher": { "@type": "Organization", "name": "Buy A Warranty", "legalName": "BUY A WARRANTY LIMITED", "url": "https://buyawarranty.co.uk" } };
  const localBusinessSchema = { "@context": "https://schema.org", "@type": "LocalBusiness", "name": "Buy A Warranty", "description": "UK's trusted Volvo extended warranty provider since 2016.", "url": "https://buyawarranty.co.uk", "telephone": "03302295040", "foundingDate": "2016", "areaServed": { "@type": "Country", "name": "United Kingdom" }, "priceRange": "£18-£60/month", "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "2847", "bestRating": "5" } };
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://buyawarranty.co.uk/warranty-types/volvo/" />
        ...
        <meta property="og:type" content="website" /><meta property="og:url" content="https://buyawarranty.co.uk/warranty-types/volvo/" />
      ...
      <main itemScope itemType="https://schema.org/WebPage">
        <section id="hero-section" className="relative bg-gradient-to-br from-blue-50 via-white to-slate-50 pt-6 pb-10 md:pt-10 md:pb-16 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-5">
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium"><Shield className="h-4 w-4" /> Official Volvo Extended Warranty Partner</div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 leading-tight">Volvo Extended <span className="text-brand-orange">Warranty</span> UK</h1>
              <p className="text-base md:text-lg text-gray-600 max-w-xl">Protect your Volvo with comprehensive cover from just <strong>£25/month</strong>. All models from 2012 to 2026 including XC40, XC60, XC90, S60, V60, V90, XC40 Recharge & C40 Recharge. AWD & T8 hybrid covered.</p>
              <div className="bg-white rounded-2xl shadow-xl p-5 md:p-6 border border-gray-100"><div className="space-y-4"><div><label htmlFor="reg-input" className="block text-sm font-semibold text-gray-700 mb-1.5">Enter Your Registration</label><div className="relative"><div className="absolute left-0 top-0 bottom-0 w-12 bg-blue-600 rounded-l-lg flex items-center justify-center"><span className="text-white text-xs font-bold">GB</span></div><input id="reg-input" type="text" value={regNumber} onChange={handleRegChange} placeholder="AB12 CDE" className="w-full pl-16 pr-4 py-3.5 text-xl font-bold uppercase tracking-wider bg-yellow-50 border-2 border-yellow-400 rounded-lg focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-center" maxLength={8} aria-label="Vehicle registration number" /></div></div><MileageQuickSelect value={mileageSelection} onChange={handleMileageSelection} />{vehicleAgeError && <div className="p-3 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm">{vehicleAgeError}</div>}<Button onClick={handleGetQuote} disabled={isLookingUp} className="w-full bg-brand-orange hover:bg-brand-orange/90 text-white font-bold py-4 text-lg rounded-xl shadow-lg animate-cta-enhanced" size="lg">{isLookingUp ? <span className="flex items-center gap-2"><div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>Looking up vehicle...</span> : <span className="flex items-center gap-2">Get My Free Quote <ArrowRight className="h-5 w-5" /></span>}</Button><div className="flex items-center justify-center gap-4 text-xs text-gray-500"><span className="flex items-center gap-1"><Check className="h-3 w-3 text-green-500" /> No obligation</span><span className="flex items-center gap-1"><Check className="h-3 w-3 text-green-500" /> Instant quote</span><span className="flex items-center gap-1"><Check className="h-3 w-3 text-green-500" /> Cancel anytime</span></div></div></div>
              <TrustCallbackPanel />
              <div className="flex items-center gap-3"><OptimizedImage src={trustpilotExcellent} alt="Trustpilot Excellent Rating" className="h-10" width={120} height={40} /><span className="text-sm text-gray-600">Rated <strong>Excellent</strong> by Volvo owners</span></div>
            </div>
            <div className="relative hidden lg:flex flex-col items-center justify-center">
              <div className="relative flex items-end justify-center gap-4"><OptimizedImage src={volvoXC60Hero} alt="Volvo XC60 extended warranty UK" className="max-w-[35%] h-auto drop-shadow-2xl" priority width={269} height={179} /><OptimizedImage src={pandaThumbsUp} alt="Buy A Warranty mascot" className="max-w-[25%] h-auto" priority width={192} height={192} /><OptimizedImage src={volvoXC90Warranty} alt="Volvo XC90 used car warranty UK" className="max-w-[35%] h-auto drop-shadow-2xl" priority width={269} height={179} /></div>
              <div className="mt-6 flex items-center gap-2"><div className="flex -space-x-1">{[...Array(5)].map((_, i) => <Star key={i} className="h-5 w-5 fill-yellow-400 text-yellow-400" />)}</div><span className="text-sm font-medium text-gray-700">Trusted by thousands of Volvo owners</span></div>
            </div>
          </div></div>
        </section>
