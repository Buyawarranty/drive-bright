        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Everything you need to know about MG extended warranties</p>
            </div>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-r from-gray-900 to-gray-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Get Your MG Warranty Quote in 60 Seconds
            </h2>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of MG owners who trust Buy A Warranty for their extended vehicle protection. From just £24/month with no hidden fees.
            </p>
            <Button
              ...
              size="lg"
            >
              Get My Free MG Quote <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
