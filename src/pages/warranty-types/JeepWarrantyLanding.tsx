...
import heroImage from '@/assets/jeep-extended-warranty-uk.png';
...
const brandSlug = 'jeep-warranty';
const brandMake = 'Jeep';
...
const faqs = [
  { question: `Is a ${brandName} extended warranty worth it in the UK?`, answer: `Absolutely. ${brandName} vehicles use specialist 4x4 components and advanced drivetrain systems that can be very expensive to repair. Our extended warranty protects key components like the engine, gearbox, transfer case, electrics, and more.` },
  ...
  { question: `Does the warranty cover 4x4 components?`, answer: `Yes, our comprehensive plan covers 4x4 specific components including the transfer case, front and rear differentials, locking hubs, and electronic 4WD systems.` },
...
const testimonials = [
  { name: "Dave R.", location: "Devon", model: "Jeep Wrangler", text: "Transfer case issue on my Wrangler was fully covered. Saved me over £3,000. Incredible service from start to finish.", rating: 5 },
  { name: "Karen L.", location: "Surrey", model: "Jeep Grand Cherokee", text: "Air suspension repair covered without any hassle. Would have cost £2,500 out of pocket. So glad I have this warranty.", rating: 5 },
  { name: "Paul M.", location: "Yorkshire", model: "Jeep Compass", text: "ECU and gearbox issue sorted quickly. The claims team were professional and kept me updated throughout.", rating: 5 },
  { name: "Helen T.", location: "Kent", model: "Jeep Renegade", text: "Turbo failure covered completely. Fast claim, no fuss. Highly recommend for any Jeep owner.", rating: 5 }
];

const repairs = [
  { name: 'Transfer Case Rebuild', cost: '£1,500 – £3,500', icon: Car, severity: 'critical' },
  { name: 'Air Suspension Repair', cost: '£1,200 – £3,000', icon: Wrench, severity: 'high' },
  { name: 'Automatic Gearbox', cost: '£2,000 – £5,000', icon: Wrench, severity: 'critical' },
  { name: 'Engine Rebuild', cost: '£3,000 – £6,000', icon: Car, severity: 'critical' },
  { name: 'Turbocharger Replacement', cost: '£1,500 – £3,000', icon: Zap, severity: 'high' },
  { name: 'ECU Replacement', cost: '£600 – £1,800', icon: Zap, severity: 'medium' },
  { name: 'Differential Repair', cost: '£800 – £2,000', icon: Wrench, severity: 'high' },
  { name: 'Power Steering Pump', cost: '£500 – £1,200', icon: Car, severity: 'medium' },
  { name: 'Starter Motor', cost: '£350 – £800', icon: Zap, severity: 'medium' },
];

const JeepWarrantyLanding: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive Jeep extended warranty cover in the UK with BuyA Warranty. Tailored protection for luxury and performance vehicles with instant online quote." />
        ...
        <meta property="og:description" content="Comprehensive Jeep extended warranty cover in the UK with BuyA Warranty. Tailored protection for luxury and performance vehicles with instant online quote." />
      ...
      <main className="min-h-screen bg-white" role="main">
              ...
              <div className="relative">
                ...
                <div className="flex flex-col items-center gap-4 mt-6">
                  <div className="flex items-center justify-center gap-3 sm:gap-4 lg:gap-6 flex-wrap">
                    <div className="flex items-center space-x-1.5"><Car className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 flex-shrink-0" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">SUVs</span></div>
                    <div className="flex items-center space-x-1.5"><Truck className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 flex-shrink-0" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">4x4</span></div>
                  </div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[{ icon: Shield, title: 'Comprehensive Cover', desc: 'Engine, gearbox, 4x4 systems & more' }, { icon: MapPin, title: 'Any UK Garage', desc: 'Choose any VAT-registered garage' }, { icon: Phone, title: 'UK Claims Team', desc: 'Fast, hassle-free claims process' }, { icon: Clock, title: 'Instant Cover', desc: 'Protection starts immediately' }].map((item, i) => (
        ...
        <RelatedInternalLinks
          links={[
            { to: '/warranty-types/kia-warranty/', label: 'kia extended warranty' },
...
export default JeepWarrantyLanding;
