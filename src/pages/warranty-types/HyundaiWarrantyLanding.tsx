...
const testimonials = [
  { name: "Mark T.", location: "Birmingham", model: "Hyundai Tucson", text: "My Tucson's DCT gearbox developed a fault at 72,000 miles. Would have cost me over £3,200 but Buy A Warranty covered everything. Brilliant service from start to finish.", rating: 5 },
...
const HyundaiWarrantyLanding: React.FC = () => {
  ...
  const handleGetQuote = async (mileageOverride?: string) => {
    ...
    try {
      ...
      if (data?.found) {
        ...
        const vehicleData = { regNumber, mileage: effectiveMileage, make: data.make || 'HYUNDAI', model: data.model, fuelType: data.fuelType, transmission: data.transmission, year: data.yearOfManufacture, vehicleType: 'car', manufactureDate: data.manufactureDate };
  ...
  const productSchema = { "@context": "https://schema.org", "@type": "Product",
      "image": ["https://buyawarranty.co.uk/extended_warranty_uk-car-trustworthy-reviews.png"], "name": "Hyundai Extended Warranty UK", "description": "Comprehensive extended warranty coverage for all Hyundai models including Tucson, i30, Kona, Santa Fe, IONIQ 5, IONIQ 6. Covers engine, gearbox, transmission, electrical systems. Nationwide UK coverage.", "brand": { "@type": "Brand", "name": "Buy A Warranty" }, "manufacturer": { "@type": "Organization", "name": "Buy A Warranty", "url": "https://buyawarranty.co.uk", "logo": "https://buyawarranty.co.uk/lovable-uploads/53652a24-3961-4346-bf9d-6588ef727aeb.png", "contactPoint": { "@type": "ContactPoint", "telephone": "+44-800-917-9270", "contactType": "customer service", "availableLanguage": "English", } }, "offers": { "@type": "Offer", "priceCurrency": "GBP", "price": String(SEO_FROM_MONTHLY_PRICE), "priceValidUntil": new Date(Date.now() + 30*24*60*60*1000).toISOString().split('T')[0], "availability": "https://schema.org/InStock", "url": "https://buyawarranty.co.uk/warranty-types/hyundai-warranty/", "seller": { "@type": "Organization", "name": "Buy A Warranty" }, "priceSpecification": { "@type": "UnitPriceSpecification", "price": String(SEO_FROM_MONTHLY_PRICE), "priceCurrency": "GBP", "unitText": "month" } }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": TRUSTPILOT_RATING_VALUE, "reviewCount": TRUSTPILOT_REVIEW_COUNT, "bestRating": "5" }, "review": testimonials.map((t, i) => ({ "@type": "Review", "author": { "@type": "Person", "name": t.name }, "reviewRating": { "@type": "Rating", "ratingValue": t.rating, "bestRating": "5" }, "reviewBody": t.text, "datePublished": new Date(Date.now() - (i+1)*7*24*60*60*1000).toISOString().split('T')[0] })), "category": "Vehicle Extended Warranty", "audience": { "@type": "Audience", "audienceType": "Hyundai vehicle owners in the United Kingdom" } };
  ...
  const localBusinessSchema = { "@context": "https://schema.org", "@type": "LocalBusiness", "name": "Buy A Warranty", "url": "https://buyawarranty.co.uk", "telephone": "+44-800-917-9270", "email": "support@buyawarranty.co.uk", "priceRange": SEO_PRICE_RANGE, "address": { "@type": "PostalAddress", "streetAddress": "124 City Road", "addressLocality": "London", "postalCode": "EC1V 2NX", "addressCountry": "GB" }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": TRUSTPILOT_RATING_VALUE, "reviewCount": TRUSTPILOT_REVIEW_COUNT } };
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-6 md:gap-8 items-start">
              ...
              <div className="hidden lg:flex justify-center items-end pt-16"><OptimizedImage src={hyundaiSantaFeTestimonials} alt="Hyundai Santa Fe front view - Why Hyundai owners choose Buy A Warranty" className="max-w-[220px] xl:max-w-[260px] h-auto object-contain" width={1024} height={768} /></div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-[1fr_auto] gap-8 items-center">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
                {[{ emoji: '✅', title: 'No hidden catches', desc: 'What you see is what you get' }, { emoji: '💰', title: '14-day cooling off period', desc: 'Try risk-free' }, { emoji: '⭐', title: '94% of claims approved fast', desc: 'We pay when you need us' }].map((c, i) => (
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-[1fr_auto] gap-8 items-center">
              ...
              <div className="hidden lg:flex justify-center"><OptimizedImage src={hyundaiSantaFeTestimonials} alt="Hyundai Santa Fe front view - Hyundai owners trust Buy A Warranty" className="max-w-[200px] xl:max-w-[240px] h-auto object-contain" width={240} height={180} /></div>
            </div>
          </div>
        </section>
