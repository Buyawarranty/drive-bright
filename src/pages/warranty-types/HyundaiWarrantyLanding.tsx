...
// Hyundai-specific images
import hyundaiTucsonHero from '@/assets/hyundai-tucson-extended-warranty-uk.png';
import hyundaiI30Warranty from '@/assets/hyundai-i30-used-car-warranty.png';
import hyundaiKonaHighMileage from '@/assets/hyundai-kona-high-mileage-warranty.png';

// Hyundai Models covered (grouped by category) - 2012 to 2026
...
// Coverage components data - Hyundai-specific
const coverageCategories = [
  {
    title: 'Engine & Powertrain',
    icon: Car,
    items: [
      'Hyundai GDi and T-GDi engine block and cylinder head',
      'Pistons, rings, and bearings',
      'Crankshaft and camshaft',
      'Timing chains and tensioners',
      'Oil pump and oil cooler',
      'Turbocharger (T-GDi / N models)',
  ...
  },
  {
    ...
    icon: Wrench,
    items: [
      'Hyundai DCT dual-clutch gearbox',
  ...
  },
  {
    ...
    items: [
      ...
      'High-pressure fuel pump (GDi/T-GDi)',
  ...
  },
  {
    ...
    icon: Zap,
    items: [
      'Electric drive motor (IONIQ 5 / IONIQ 6 / Kona EV)',
      'Power electronics module',
      'DC-DC converter',
      'On-board charger (800V ultra-fast)',
...
const hyundaiFAQs = [
  {
    question: "Is a Hyundai extended warranty worth it in the UK?",
    answer: "Yes, modern Hyundais feature complex GDi and T-GDi turbo engines, DCT gearboxes, Bluelink connected systems, and hybrid/EV technology that can be costly to repair outside of the manufacturer warranty. Our extended warranty protects key components including the engine, turbocharger, gearbox, fuel injectors, and ECUs, preventing unexpected repair bills."
  },
  {
    question: "How much does a Hyundai extended warranty cost in the UK?",
    answer: "Extended Hyundai warranty prices typically start from £24 a month, depending on your Hyundai model, mileage, and chosen claim limit. We offer plans from just 80p a day with flexible monthly or annual payment options."
  },
  {
    question: "Can I buy a Hyundai extended warranty after my 5-year warranty has expired?",
    answer: "Yes, you can buy cover even if your Hyundai's original 5-year manufacturer warranty has expired, or if you purchased it used without the remaining warranty transferring. We cover vehicles up to 150,000 miles and 15 years old."
  },
  {
    question: "Can I use my own garage for Hyundai warranty repairs?",
    answer: "Yes, absolutely. You can choose any VAT-registered garage across the UK instead of being restricted to Hyundai dealers. We have a network of approved garages nationwide."
  },
  {
    question: "Does the warranty cover hybrid and electric Hyundai models?",
    answer: "Yes, our comprehensive plan includes cover for Hyundai's hybrid and fully electric components including the IONIQ 5 and IONIQ 6 electric motors, 800V ultra-fast charging system, battery management, power electronics, on-board charger, and thermal management systems."
  },
  {
    question: "Is roadside assistance included?",
    answer: "Yes, our comprehensive plan includes 24/7 roadside assistance and recovery anywhere in the UK. If your Hyundai breaks down, we'll send help to get you back on the road or recover your vehicle to a garage."
  },
  {
    question: "How do I make a claim on my Hyundai warranty?",
...
const testimonials = [
  {
    ...
    text: "My Tucson needed a new turbo at 72,000 miles. Would have cost me over £2,800 but my warranty covered everything. Excellent service from start to finish.",
    rating: 5
  },
  {
    name: "Claire H.",
    location: "Birmingham",
    model: "Hyundai i30",
    text: "The DCT gearbox on my i30 developed a fault after the Hyundai warranty expired. Buy A Warranty handled the whole claim without any fuss. Back on the road in two days.",
    rating: 5
  },
  {
    name: "Mark R.",
    ...
    text: "Finding warranty cover for my Kona Electric was tricky until I found these guys. They cover all the EV components and the price is very reasonable.",
    rating: 5
  },
  {
    name: "Sophie T.",
    ...
    text: "I wanted peace of mind for my IONIQ 5 after the manufacturer warranty. These guys cover all the EV components including the 800V system. Couldn't be happier.",
    rating: 5
  }
];
...
const HyundaiWarrantyLanding: React.FC = () => {
  ...
  const filteredModels = useMemo(() => {
    const allModels = activeModelFilter === 'All'
      ? Object.entries(hyundaiModelCategories).flatMap(([category, models]) => 
          Object.entries(models).map(([model, generations]) => ({ model, generations, category }))
        )
      : Object.entries(hyundaiModelCategories[activeModelFilter]).map(([model, generations]) => ({ 
          model, 
          generations, 
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Hyundai Extended Warranty UK",
    "description": "Comprehensive extended warranty coverage for all Hyundai models including Tucson, i30, Kona, Santa Fe, IONIQ 5, IONIQ 6, i20, and i10. Covers engine, turbo, gearbox, electrical systems, hybrid and EV components. Nationwide UK coverage with any VAT-registered garage.",
    ...
    "audience": { "@type": "Audience", "audienceType": "Hyundai vehicle owners in the United Kingdom" }
  };

  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Hyundai Extended Warranty Service",
    "alternateName": "Hyundai Used Car Warranty",
    "provider": {
      "@type": "LocalBusiness",
      "name": "Buy A Warranty",
      "url": "https://buyawarranty.co.uk",
    ...
    "description": "Extended warranty coverage for all Hyundai models including Tucson, i30, Kona, Santa Fe, IONIQ 5, and IONIQ 6. Covers GDi/T-GDi engines, DCT gearboxes, Bluelink systems, and hybrid/EV components.",
    "serviceType": "Vehicle Extended Warranty",
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Hyundai Warranty Plans",
      "itemListElement": [
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Basic Hyundai Warranty" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Gold Hyundai Warranty" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Platinum Hyundai Warranty" } }
      ]
    }
  };
  ...
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": hyundaiFAQs.map(faq => ({
      "@type": "Question",
      "name": faq.question,
  ...
  const localBusinessSchema = {
    ...
    "name": "Buy A Warranty",
    "description": "UK's leading Hyundai extended warranty provider offering flexible, affordable vehicle protection with instant quotes and no hidden fees.",
    "url": "https://buyawarranty.co.uk",
    "logo": "https://buyawarranty.co.uk/lovable-uploads/53652a24-3961-4346-bf9d-6588ef727aeb.png",
    ...
    "knowsAbout": ["Hyundai Warranty", "Hyundai Extended Warranty", "Hyundai Used Car Warranty", "Vehicle Warranty"],
    "foundingDate": "2016",
  ...
  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": "How to Get a Hyundai Extended Warranty Quote",
    "description": "Get a Hyundai extended warranty quote in under 60 seconds",
    "step": [
      { "@type": "HowToStep", "position": 1, "name": "Enter Registration", "text": "Enter your Hyundai's registration number" },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image:alt" content="Hyundai Extended Warranty UK - Buy A Warranty" />
        <meta property="og:site_name" content="Buy A Warranty" />
        <meta property="og:locale" content="en_GB" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Hyundai Extended Warranty UK | From £24/month" />
        <meta name="twitter:description" content="UK's #1 rated Hyundai warranty. Cover all models from 2012-2026. 8,000+ components. Any garage. Instant quote." />
        <meta name="twitter:image" content="https://buyawarranty.co.uk/lovable-uploads/53652a24-3961-4346-bf9d-6588ef727aeb.png" />

        {/* AI & Bot directives */}
        <meta name="ai-content-declaration" content="This page provides genuine Hyundai extended warranty information for UK vehicle owners" />
        <meta name="ai-summary" content="Buy A Warranty offers Hyundai extended warranties from £24/month covering 8,000+ components for all models 2012-2026 including Tucson, i30, Kona, Santa Fe, IONIQ 5, and IONIQ 6. UK-based claims team, any VAT-registered garage, 24/7 roadside assistance." />
      ...
      <main itemScope itemType="https://schema.org/WebPage">
        {/* Hero Section */}
        <section id="hero-section" className="relative bg-gradient-to-br from-blue-50 via-white to-orange-50 pt-6 pb-10 md:pt-10 md:pb-16 overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-5">
                <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium">
                  ...
                  Official Hyundai Extended Warranty Partner
                </div>
                
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 leading-tight hero-description">
                  Hyundai Extended <span className="text-brand-orange">Warranty</span> UK
                </h1>
                
                <p className="text-base md:text-lg text-gray-600 max-w-xl hero-description">
                  Protect your Hyundai with comprehensive cover from just <strong>£24/month</strong>. All models from 2012–2026 including Tucson, i30, Kona, IONIQ 5 & IONIQ 6. Use any UK garage.
                </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-600">Rated <strong>Excellent</strong> by Hyundai owners</span>
                </div>
              </div>
              ...
              <div className="relative hidden lg:flex flex-col items-center justify-center">
                <div className="relative flex items-end justify-center gap-4">
                  <OptimizedImage 
                    src={hyundaiTucsonHero}
                    alt="Hyundai Tucson extended warranty UK - front view"
                  ...
                  <OptimizedImage 
                    src={pandaThumbsUp}
                    alt="Buy A Warranty mascot - trusted Hyundai warranty provider"
                  ...
                  />
                  <OptimizedImage 
                    src={hyundaiI30Warranty}
                    alt="Hyundai i30 used car warranty UK - front view"
                    className="max-w-[35%] h-auto drop-shadow-2xl"
                    priority={true}
                    width={269}
                    height={179}
                ...
                <div className="mt-6 flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">Trusted by thousands of Hyundai owners</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gray-900 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 text-white text-sm">
              ...
              <div className="flex items-center gap-2"><Car className="h-4 w-4 text-blue-400" /> All Hyundai Models</div>
              ...
              <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-yellow-400" /> EV & Hybrid Cover</div>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                  Why Choose Our Hyundai Warranty?
                </h2>
                <p className="text-gray-600">
                  Hyundai vehicles are known for reliability, but modern GDi and T-GDi engines, DCT gearboxes, and advanced electronic systems can still develop costly faults after the manufacturer warranty expires.
                </p>
                <div className="space-y-4">
                  {[
                    { icon: Shield, title: 'Comprehensive Cover', desc: 'Over 8,000 mechanical and electrical components protected on every plan' },
                    { icon: Wrench, title: 'Any UK Garage', desc: 'Choose any VAT-registered garage — not restricted to Hyundai dealers' },
                    { icon: Zap, title: 'EV & Hybrid Ready', desc: 'Full cover for IONIQ 5, IONIQ 6, Kona Electric, and all hybrid models' },
              ...
              <div className="flex justify-center pt-16">
                <OptimizedImage 
                  src={hyundaiKonaHighMileage}
                  alt="Hyundai Kona high mileage warranty UK - front view"
        ...
        <BrandRepairCosts
          ...
          repairs={[
            { name: 'DCT Gearbox Rebuild', cost: '£1,800 – £3,500', icon: 'Wrench', severity: 'critical' },
            { name: 'Turbocharger (T-GDi)', cost: '£1,500 – £3,000', icon: 'Zap', severity: 'high' },
            { name: 'Engine Rebuild', cost: '£3,000 – £5,500', icon: 'Car', severity: 'critical' },
            { name: 'EV Drive Motor (IONIQ 5)', cost: '£2,500 – £5,000', icon: 'Zap', severity: 'high' },
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-6">
              {(['All', ...Object.keys(hyundaiModelCategories)] as (ModelCategory | 'All')[]).map((cat) => (
                <button
                  key={cat}
            ...
            <div className="max-w-sm mx-auto mb-6">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search Hyundai models..."
            ...
            <div className="text-center mt-8">
              <Button onClick={scrollToQuoteForm} className="bg-brand-orange hover:bg-brand-orange/90 text-white font-bold px-8 py-3 rounded-xl shadow-lg">
                Get Your Hyundai Quote <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                What's Covered on Your Hyundai?
              </h2>
              <p className="text-gray-600">Comprehensive protection for all major Hyundai systems</p>
            </div>
              ...
              {testimonials.map((t, i) => (
                <div key={i} className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                  ...
                  <div className="text-sm">
                    ...
                    <span className="text-gray-500"> • {t.model} • {t.location}</span>
                  </div>
                </div>
              ))}
            </div>
