...
import heroImage from '@/assets/chevrolet-extended-warranty-uk.png';
...
const brandName = 'Chevrolet';
const brandSlug = 'chevrolet-warranty';
const brandMake = 'Chevrolet';
const startingPrice = '24';

const modelCategories = {
  'Sports Cars': { 'Camaro': ['5th Gen', '6th Gen'], 'Corvette': ['C7', 'C8'] },
  'SUVs': { 'Tahoe': ['GMT', 'T1XX'], 'Suburban': ['GMT', 'T1XX'], 'Trax': [''], 'Captiva': ['C100', 'C140'] },
  'Pickup': { 'Silverado': ['K2XX', 'T1XX'] },
  'Hatchbacks': { 'Spark': ['M300'], 'Aveo': ['T300'], 'Orlando': ['J309'] },
};

type ModelCategory = keyof typeof modelCategories;

const faqs = [
  { question: "Is a Chevrolet extended warranty worth it in the UK?", answer: "Yes. Chevrolet parts sourced in the UK can be expensive due to limited availability. Engine or transmission failures cost £3,000–£8,000. Our warranty gives you peace of mind." },
  { question: "How much does a Chevrolet extended warranty cost?", answer: `Chevrolet warranty prices start from £${startingPrice}/month depending on model, mileage, and claim limit.` },
  { question: "Can I use my own garage?", answer: "Yes, any VAT-registered garage in the UK, including American car specialists and independent garages." },
  { question: "Are V8 engines covered?", answer: "Yes, all Chevrolet engines including LS and LT V8s are fully covered including all internal components." },
  { question: "Is the Corvette covered?", answer: "Yes, we cover all Corvette models including the mid-engine C8, covering engine, transmission, differential, and electronics." },
...
const testimonials = [
  { name: "Gary P.", location: "Essex", model: "Chevrolet Camaro", text: "Transmission rebuild covered in full — saved me £4,200. Brilliant service for American car owners.", rating: 5 },
  { name: "James M.", location: "Bristol", model: "Chevrolet Corvette", text: "Differential issue sorted fast. £2,800 claim paid with no fuss. Essential for Corvette owners in the UK.", rating: 5 },
  { name: "Helen T.", location: "London", model: "Chevrolet Captiva", text: "Turbo failed on my Captiva — fully covered. So glad I had this warranty. Highly recommend.", rating: 5 },
  { name: "Andrew B.", location: "Manchester", model: "Chevrolet Silverado", text: "Great cover for my imported Silverado. Engine sensor failure dealt with quickly.", rating: 5 }
];

const repairs = [
  { name: 'V8 Engine Rebuild', cost: '£3,500 – £8,000', icon: Wrench, severity: 'critical' as const },
  { name: 'Automatic Transmission', cost: '£2,500 – £5,500', icon: Car, severity: 'critical' as const },
  { name: 'Rear Differential', cost: '£1,200 – £2,800', icon: Wrench, severity: 'high' as const },
  ...
  { name: 'Transfer Case (4WD)', cost: '£1,500 – £3,000', icon: Truck, severity: 'high' as const },
...
const ChevroletWarrantyLanding: React.FC = () => {
    ...
    <>
      ...
      <main className="min-h-screen bg-white" role="main">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <div className="mx-auto lg:mx-0 space-y-4">
                  ...
                  <p className="text-xs text-gray-500 mt-3 text-center lg:text-left">{brandName} is a registered trademark of General Motors. We are an independent warranty provider.</p>
                  <TrustCallbackPanel />
                </div>
              </div>
              <div className="relative">
                ...
                <div className="flex flex-col items-center gap-4 mt-6">
                  <div className="flex items-center justify-center gap-3 sm:gap-4 lg:gap-6 flex-wrap">
                    ...
                    <div className="flex items-center space-x-1.5"><Truck className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">SUVs & Trucks</span></div>
                  </div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">American-spec parts in the UK can be costly — protect yourself from unexpected bills.</p>
            </div>
            ...
            <div className="mt-8 md:mt-12 text-center">
              <div className="bg-brand-deep-blue rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-4">
                  <div className="text-center"><p className="text-xs md:text-sm font-semibold text-white/60 uppercase tracking-wider mb-1">Typical repair</p><p className="text-2xl md:text-4xl font-bold text-red-400 line-through decoration-2">£3,800</p></div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[{ icon: Shield, title: 'Comprehensive Cover', desc: 'V8, transmission, electrics & more' }, { icon: MapPin, title: 'Any UK Garage', desc: 'Any VAT-registered garage' }, { icon: Phone, title: 'UK Claims Team', desc: 'Fast, hassle-free claims' }, { icon: Clock, title: 'Instant Cover', desc: 'Protection starts immediately' }].map((item, i) => (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-center md:text-left">
                ...
                <ul className="space-y-2 text-left max-w-md mx-auto md:mx-0">
                  {['Use any VAT-registered garage', 'Chevrolet specialist or independent', 'Recovery to nearest garage', 'UK-based claims team'].map((item, i) => (<li key={i} className="flex items-center gap-2"><Check className="w-5 h-5 text-green-400 flex-shrink-0" /><span>{item}</span></li>))}
                </ul>
              </div>
        ...
        <RelatedInternalLinks
          links={[
            { to: '/warranty-types/chrysler-warranty/', label: 'chrysler extended warranty' },
...
export default ChevroletWarrantyLanding;
