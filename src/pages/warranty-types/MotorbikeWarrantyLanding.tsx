    ...
    try {
      ...
      if (data?.found) {
        ...
        toast({
          ...
          description: "We couldn't find your motorcycle. Please check the registration and try again.",
          variant: "destructive",
        });
      }
    } catch (err) {
      ...
      toast({
        title: "Lookup Error",
        description: "There was a problem looking up your motorcycle. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLookingUp(false);
