        ...
        <section className="py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 md:mt-12 text-center">
              <div className="bg-slate-900 rounded-2xl p-6 md:p-10 max-w-3xl mx-auto">
                ...
                <Button
                  onClick={scrollToQuoteForm}
                  className="bg-[#FF6B00] hover:bg-orange-600 text-white font-bold px-8 md:px-10 py-4 md:py-5 text-base md:text-lg rounded-xl animate-breathing shadow-lg shadow-orange-500/25"
                >
