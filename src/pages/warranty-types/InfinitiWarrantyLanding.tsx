...
import heroImage from '@/assets/infiniti-extended-warranty-uk.png';
...
const modelCategories = {
  'Saloons': { 'Q50': ['V37'], 'Q70': ['Y51'] },
  'SUVs & Crossovers': { 'QX30': ['H15'], 'QX50': ['J55'], 'QX60': ['L50'], 'QX70': ['S51'], 'QX80': ['Z62'] },
  'Coupés': { 'Q60': ['CV37'] },
};
...
const faqs = [
  { question: "Is an Infiniti extended warranty worth it?", answer: "Absolutely. Infiniti vehicles use premium Nissan-derived engineering with luxury components. A turbo or gearbox failure can cost £2,000–£5,000. Our warranty protects you from unexpected bills." },
  { question: "How much does an Infiniti extended warranty cost?", answer: `Infiniti warranty prices start from £${startingPrice}/month depending on model, mileage, and claim limit. Flexible monthly or annual payments available.` },
  { question: "Can I get cover after my Infiniti dealer warranty expires?", answer: "Yes, we cover vehicles up to 150,000 miles and 15 years old, even after manufacturer warranty has expired." },
  { question: "Can I use my own garage?", answer: "Yes, any VAT-registered garage in the UK, including Infiniti specialists and independent garages." },
  { question: "Are turbo models covered?", answer: "Yes, all turbocharged Infiniti models are fully covered including the turbocharger, intercooler, and boost control systems." },
  { question: "Is the Infiniti Q50 covered?", answer: "Yes, we cover all Q50 variants including the 2.0t, 3.0t twin-turbo, and hybrid models with full mechanical and electrical protection." },
...
const testimonials = [
  { name: "Andrew S.", location: "Surrey", model: "Infiniti Q50", text: "Twin-turbo issue fully covered — would have been £3,800 out of pocket. Outstanding service!", rating: 5 },
  { name: "Karen L.", location: "Cheshire", model: "Infiniti QX70", text: "Gearbox problem sorted quickly. £2,900 claim paid without any fuss. Excellent warranty.", rating: 5 },
  { name: "Paul T.", location: "Hampshire", model: "Infiniti Q60", text: "Air suspension failure — fully covered. Saved me over £2,500. Highly recommend.", rating: 5 },
  { name: "Diane H.", location: "Berkshire", model: "Infiniti QX50", text: "ECU and sensor issues covered completely. The claims process was so smooth.", rating: 5 }
];

const repairs = [
  { name: 'Twin-Turbo Replacement', cost: '£2,500 – £5,000', icon: Zap, severity: 'critical' as const },
  { name: 'Automatic Gearbox', cost: '£2,000 – £4,500', icon: Wrench, severity: 'critical' as const },
  { name: 'Air Suspension System', cost: '£1,500 – £3,500', icon: Car, severity: 'high' as const },
  { name: 'Hybrid Battery Pack', cost: '£2,000 – £5,000', icon: Battery, severity: 'critical' as const },
  { name: 'ECU Replacement', cost: '£1,000 – £2,500', icon: Zap, severity: 'high' as const },
  { name: 'Fuel Injector Set', cost: '£800 – £2,000', icon: Zap, severity: 'medium' as const },
  { name: 'Power Steering Rack', cost: '£900 – £2,200', icon: Wrench, severity: 'high' as const },
  { name: 'Catalytic Converter', cost: '£1,200 – £2,800', icon: Wrench, severity: 'high' as const },
  { name: 'Drive Shaft Assembly', cost: '£700 – £1,800', icon: Car, severity: 'medium' as const },
];

const InfinitiWarrantyLanding: React.FC = () => {
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <div className="mx-auto lg:mx-0 space-y-4">
                  ...
                  <p className="text-xs text-gray-500 mt-3 text-center lg:text-left">{brandName} is a registered trademark of Nissan Motor Co. We are an independent warranty provider.</p>
                  <TrustCallbackPanel />
                </div>
              </div>
              <div className="relative">
                ...
                <div className="flex flex-col items-center gap-4 mt-6">
                  <div className="flex items-center justify-center gap-3 sm:gap-4 lg:gap-6 flex-wrap">
                    <div className="flex items-center space-x-1.5"><Car className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">Saloons</span></div>
                    ...
                    <div className="flex items-center space-x-1.5"><Car className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">Coupés</span></div>
                  </div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">Infiniti's luxury components mean premium repair costs without cover.</p>
            </div>
            ...
            <div className="mt-8 md:mt-12 text-center">
              <div className="bg-brand-deep-blue rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-4">
                  <div className="text-center"><p className="text-xs md:text-sm font-semibold text-white/60 uppercase tracking-wider mb-1">Typical repair</p><p className="text-2xl md:text-4xl font-bold text-red-400 line-through decoration-2">£3,200</p></div>
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[{ icon: Shield, title: 'Comprehensive Cover', desc: 'Engine, turbo, electrics & more' }, { icon: MapPin, title: 'Any UK Garage', desc: 'Any VAT-registered garage' }, { icon: Phone, title: 'UK Claims Team', desc: 'Fast, hassle-free claims' }, { icon: Clock, title: 'Instant Cover', desc: 'Protection starts immediately' }].map((item, i) => (
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-center md:text-left">
                ...
                <ul className="space-y-2 text-left max-w-md mx-auto md:mx-0">
                  {['Use any VAT-registered garage', 'Infiniti specialist or independent', 'Recovery to nearest garage', 'UK-based claims team'].map((item, i) => (<li key={i} className="flex items-center gap-2"><Check className="w-5 h-5 text-green-400 flex-shrink-0" /><span>{item}</span></li>))}
                </ul>
              </div>
...
export default InfinitiWarrantyLanding;
