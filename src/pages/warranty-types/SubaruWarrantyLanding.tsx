...
import heroImage from '@/assets/subaru-extended-warranty-uk.png';
...
const brandName = 'Subaru';
const brandSlug = 'subaru-warranty';
const brandMake = 'Subaru';
...
const faqs = [
  { question: `Is a ${brandName} extended warranty worth it in the UK?`, answer: `Yes, ${brandName} vehicles use unique boxer engines and symmetrical AWD systems that require specialist knowledge to repair. Our extended warranty protects key components like the engine, gearbox, AWD system, electrics, and more.` },
  ...
  { question: `Does the warranty cover the boxer engine and AWD system?`, answer: `Yes, our comprehensive plan covers the boxer engine, symmetrical AWD system, centre differential, and all drivetrain components.` },
...
const testimonials = [
  { name: "Chris B.", location: "Lake District", model: "Subaru Forester", text: "Head gasket issue covered completely. Would have been £2,500 at a Subaru dealer. Claims team were brilliant.", rating: 5 },
  { name: "Emma W.", location: "Scotland", model: "Subaru Outback", text: "AWD centre diff repair was fully covered. My Outback is essential for country roads and this warranty gives me peace of mind.", rating: 5 },
  { name: "Tom P.", location: "Wales", model: "Subaru XV", text: "CVT gearbox issue sorted quickly and professionally. Saved me over £3,000. Highly recommend.", rating: 5 },
  { name: "Neil H.", location: "Norfolk", model: "Subaru BRZ", text: "Excellent cover for my BRZ. Clutch release bearing was replaced under warranty with no hassle at all.", rating: 5 }
];

const repairs = [
  { name: 'Head Gasket Replacement', cost: '£1,500 – £3,000', icon: Car, severity: 'critical' },
  { name: 'CVT Gearbox Rebuild', cost: '£2,500 – £5,000', icon: Wrench, severity: 'critical' },
  { name: 'Boxer Engine Rebuild', cost: '£3,000 – £6,000', icon: Car, severity: 'critical' },
  { name: 'AWD Centre Diff', cost: '£1,000 – £2,500', icon: Wrench, severity: 'high' },
  { name: 'Turbocharger (WRX)', cost: '£1,200 – £2,800', icon: Zap, severity: 'high' },
  { name: 'ECU Replacement', cost: '£600 – £1,500', icon: Zap, severity: 'medium' },
  { name: 'Power Steering Rack', cost: '£500 – £1,200', icon: Car, severity: 'medium' },
  { name: 'Starter Motor', cost: '£300 – £700', icon: Zap, severity: 'medium' },
  { name: 'EV Battery Module', cost: '£2,000 – £5,000', icon: Battery, severity: 'critical' },
];

const SubaruWarrantyLanding: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive Subaru extended warranty cover in the UK with BuyA Warranty. Tailored protection for luxury and performance vehicles with instant online quote." />
        ...
        <meta property="og:description" content="Comprehensive Subaru extended warranty cover in the UK with BuyA Warranty. Tailored protection for luxury and performance vehicles with instant online quote." />
      ...
      <main className="min-h-screen bg-white" role="main">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <div className="mx-auto lg:mx-0 space-y-4">
                  ...
                  <p className="text-xs text-gray-500 mt-3 text-center lg:text-left">{brandName} is a registered trademark of Subaru Corporation. We are an independent warranty provider.</p>
                  <TrustCallbackPanel />
                </div>
              </div>
              <div className="relative">
                ...
                <div className="flex flex-col items-center gap-4 mt-6">
                  <div className="flex items-center justify-center gap-3 sm:gap-4 lg:gap-6 flex-wrap">
                    ...
                    <div className="flex items-center space-x-1.5"><Truck className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 flex-shrink-0" /><span className="font-medium text-gray-700 text-xs sm:text-sm lg:text-base">AWD</span></div>
            ...
            <div className="mt-8 md:mt-12 text-center">
              <div className="bg-brand-deep-blue rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-4">
                  <div className="text-center"><p className="text-xs md:text-sm font-semibold text-white/60 uppercase tracking-wider mb-1">Typical repair</p><p className="text-2xl md:text-4xl font-bold text-red-400 line-through decoration-2">£2,000</p></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 md:gap-3">
              {filteredModels.map(({ model, generations, category }) => {
                const isElectric = model === 'Solterra';
                return (
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[{ icon: Shield, title: 'Comprehensive Cover', desc: 'Boxer engine, AWD, gearbox & more' }, { icon: MapPin, title: 'Any UK Garage', desc: 'Choose any VAT-registered garage' }, { icon: Phone, title: 'UK Claims Team', desc: 'Fast, hassle-free claims process' }, { icon: Clock, title: 'Instant Cover', desc: 'Protection starts immediately' }].map((item, i) => (
        ...
        <RelatedInternalLinks
          links={[
            { to: '/warranty-types/suzuki-warranty/', label: 'suzuki extended warranty' },
...
export default SubaruWarrantyLanding;
