...
const VauxhallWarrantyLanding: React.FC = () => {
  ...
  const productSchema = { "@context": "https://schema.org", "@type": "Product", "name": "Vauxhall Extended Warranty UK", "description": "Comprehensive extended warranty for Vauxhall models including Corsa, Astra, Grandland, Mokka, Insignia, Crossland, Corsa-e, Mokka-e. Turbo engines, auto gearbox, EV components covered.", "brand": { "@type": "Brand", "name": "Buy A Warranty" }, "offers": { "@type": "Offer", "priceCurrency": "GBP", "price": "18", "availability": "https://schema.org/InStock", "url": "https://buyawarranty.co.uk/warranty-types/vauxhall-warranty/", "priceValidUntil": new Date(Date.now() + 30*24*60*60*1000).toISOString().split('T')[0] }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "2847", "bestRating": "5" }, "category": "Vehicle Extended Warranty" };
  const webPageSchema = { "@context": "https://schema.org", "@type": "WebPage", "name": "Vauxhall Extended Warranty UK | Buy A Warranty", "description": "Comprehensive Vauxhall extended warranty from £18/month covering Corsa, Astra, Grandland and all models. 8,000+ components covered.", "url": "https://buyawarranty.co.uk/warranty-types/vauxhall-warranty/", "lastReviewed": new Date().toISOString().split('T')[0], "reviewedBy": { "@type": "Organization", "name": "Buy A Warranty" }, "speakable": { "@type": "SpeakableSpecification", "cssSelector": ["h1", "h2", ".faq-question"] }, "publisher": { "@type": "Organization", "name": "Buy A Warranty", "legalName": "BUY A WARRANTY LIMITED", "url": "https://buyawarranty.co.uk" } };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:type" content="website" /><meta property="og:url" content="https://buyawarranty.co.uk/warranty-types/vauxhall-warranty/" />
