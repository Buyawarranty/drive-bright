...
const coverageCategories = [
  {
    ...
    icon: Car,
    items: ['Vauxhall turbo petrol engine block and cylinder head', '1.5 diesel engine internals and turbocharger', 'Pistons, rings, and bearings', 'Crankshaft and camshaft assemblies', 'Timing chain/belt and tensioners', 'Oil pump and oil cooler', 'Intake and exhaust manifolds'],
  },
  {
    title: 'Transmission & Drivetrain',
    icon: Wrench,
    items: ['Automatic gearbox internals', 'Manual gearbox internals', 'Torque converter', 'e-CMP electric drivetrain', 'Drive shafts and CV joints', 'Differential', 'Clutch actuator'],
  },
  {
    title: 'Electrical & Electronics',
    icon: Zap,
    items: ['ECU and engine control modules', 'Pure Panel digital cockpit', 'Multimedia Navi Pro infotainment', 'Driver assistance sensors and cameras', 'Electric window motors', 'Central locking and keyless entry', 'Starter motor and alternator'],
  },
  {
  ...
  },
  {
    ...
    icon: Zap,
    items: ['Electric drive motor (Corsa-e/Mokka-e)', 'Power electronics and inverter', 'DC-DC converter', 'On-board charger', 'Battery management system', 'Regenerative braking system', 'Thermal management system'],
  },
];
...
const vauxhallFAQs = [
  ...
  { question: "How much does a Vauxhall warranty cost?", answer: "Prices start from £19/month. Get an instant quote for your specific Vauxhall model and mileage." },
...
const testimonials = [
  ...
  { name: "Diane M.", location: "Newcastle", model: "Vauxhall Crossland", text: "Water pump failure on my Crossland. Claim approved same day and repaired at my local garage. Fantastic.", rating: 5 },
];
...
const VauxhallWarrantyLanding: React.FC = () => {
  ...
  const filteredModels = useMemo(() => {
    const allModels = activeModelFilter === 'All'
      ? Object.entries(vauxhallModelCategories).flatMap(([category, models]) =>
          Object.entries(models).map(([model, generations]) => ({ model, generations, category }))
        )
      : Object.entries(vauxhallModelCategories[activeModelFilter]).map(([model, generations]) => ({
  ...
  const handleGetQuote = async (mileageOverride?: string) => {
    ...
    try {
      ...
      const vehicleData = data?.found
        ? { regNumber, mileage: effectiveMileage, make: data.make || 'VAUXHALL', model: data.model, fuelType: data.fuelType, transmission: data.transmission, year: data.yearOfManufacture, vehicleType: 'car', manufactureDate: data.manufactureDate }
  ...
  const serviceSchema = {
    ...
    "provider": { "@type": "LocalBusiness", "name": "Buy A Warranty", "url": "https://buyawarranty.co.uk", "telephone": "+44-330-229-5040", "priceRange": SEO_PRICE_RANGE, "address": { "@type": "PostalAddress", "streetAddress": "Warranty House, 62 Berkhamsted Avenue", "addressLocality": "Wembley", "addressRegion": "London", "postalCode": "HA9 6DT", "addressCountry": "GB" } },
  ...
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": vauxhallFAQs.map(f => ({ "@type": "Question", "name": f.question, "acceptedAnswer": { "@type": "Answer", "text": f.answer } })),
  };
  ...
  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": "How to Get a Vauxhall Extended Warranty Quote",
    "description": "Get an instant Vauxhall extended warranty quote in 60 seconds",
    "totalTime": "PT1M",
    "step": [
      { "@type": "HowToStep", "position": 1, "name": "Enter Registration", "text": "Enter your Vauxhall registration number to look up your vehicle details automatically" },
    ...
    <>
      ...
      <main className="min-h-screen bg-white" role="main" itemScope itemType="https://schema.org/WebPage">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-3 md:mb-4">
                  <span className="text-gray-900">Protect your Vauxhall</span>
                  <br />
        ...
        <Suspense fallback={<div className="py-12 md:py-20 bg-gray-50 min-h-[300px]" />}>
          <WarrantyBenefitsSection headline="The Ultimate Vauxhall Warranty." />
        </Suspense>

        {/* 3. Vehicle Coverage Accordion */}
        <Suspense fallback={<div className="py-12 md:py-16 bg-gray-50 min-h-[300px]" />}>
          <VehicleCoverageSection headingPrefix="Vauxhall" />
        </Suspense>
        ...
        {/* 6. What Vauxhall Repairs Actually Cost */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
                What Vauxhall repairs actually cost
              </h2>
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
                One breakdown could cost more than years of warranty cover. Here's what Vauxhall owners pay without protection.
              </p>
            </div>
        ...
        {/* 7. Vauxhall Models Section - Premium Design */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-3 md:mb-4">
                All Vauxhall Models Covered
              </h2>
              <p className="text-base md:text-lg text-slate-600 max-w-2xl mx-auto">
                Select your Vauxhall model to see tailored warranty options designed for your vehicle.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-8 md:mb-10 sticky top-0 bg-gradient-to-b from-slate-50 via-slate-50 to-transparent py-4 md:py-5 z-10 -mx-4 px-4">
              {(['All', ...Object.keys(vauxhallModelCategories)] as (ModelCategory | 'All')[]).map(cat => (
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 md:gap-3">
              {filteredModels.map(({ model, generations, category }) => {
                ...
                return (
                  ...
                  }`} aria-label={`Vauxhall ${model}, generations ${generations.join(', ')}`}>
            ...
            <div className="mt-8 md:mt-10 text-center">
              <div className="inline-flex items-center gap-2 bg-slate-100 rounded-full px-4 py-2 text-xs md:text-sm text-slate-600">
                ...
                <span><strong>Also covered:</strong> SRi, Elite, Griffin, GS Line, and all trim variants</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 py-3 md:py-4 px-4 z-50 animate-in slide-in-from-bottom duration-300 shadow-2xl">
            <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="flex items-center gap-3 text-sm md:text-base">
                ...
                <div>
                  <p className="font-bold text-slate-900">Vauxhall {selectedModel} selected</p>
              ...
              <Button onClick={scrollToQuoteForm} className="w-full sm:w-auto bg-brand-orange hover:bg-orange-600 text-white font-bold px-6 md:px-8 py-3 md:py-4 text-sm md:text-base rounded-xl animate-breathing shadow-lg shadow-orange-500/25">
                Get warranty quote for Vauxhall
        ...
        {/* 9. Why Vauxhall Drivers Choose Us */}
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
                Why Vauxhall Drivers Choose Us
              </h2>
              <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="inline-flex items-center gap-2 bg-brand-orange text-white font-bold px-6 md:px-10 py-4 md:py-5 rounded-xl text-base md:text-lg animate-breathing mt-4">
                Get Vauxhall Warranty <ArrowRight className="w-5 h-5 md:w-6 md:h-6" />
              </button>
            </div>
            <div className="grid lg:grid-cols-3 gap-6 md:gap-8 items-start">
              <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-6">
                {[
                  ...
                  { icon: Users, title: 'UK support team that knows Vauxhall systems', desc: 'Our friendly UK-based team handles claims quickly and fairly.' },
                  { icon: Car, title: 'High mileage Vauxhall warranty plans', desc: 'Cover vehicles up to 150,000 miles with no mileage restrictions during cover.' },
              ...
              <div className="hidden lg:flex justify-center items-end">
                <OptimizedImage src={vauxhallWhyChooseUs} alt="Vauxhall Corsa - Why Vauxhall owners choose us for extended warranty" className="w-[400px] h-auto object-contain" width={400} height={300} />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
              {[
                ...
                { step: 3, title: 'Repair', desc: 'You approve and the garage repairs your Vauxhall' },
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
                Your Vauxhall cover, made <span className="text-brand-orange">crystal clear</span>
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-6 md:gap-10 items-center">
              ...
              <div className="text-center lg:text-left">
                <div className="text-green-600 text-xs md:text-sm font-semibold uppercase tracking-wide mb-3 md:mb-4">
                  High Mileage Vauxhall, No Problem!
                </div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-6">
                  Drive Your Vauxhall With Confidence<br />
                  <span className="text-brand-orange">You're Covered</span>
                </h2>
                <p className="text-base md:text-lg text-gray-600 mb-4 md:mb-6">
                  Once you have your Vauxhall warranty, drive with complete peace of mind. If something
        ...
        <section className="py-10 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
                Additional Vauxhall Cover Options
              </h2>
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-2">
                Enhance your Vauxhall warranty with these optional extras
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-gray-100">
                ...
                <p className="text-sm md:text-base text-gray-600">Keep moving while your Vauxhall is being repaired</p>
              </div>
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-gray-100">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="text-center md:text-left">
                ...
                <p className="text-base md:text-lg text-white mb-4 md:mb-6">
                  Your Vauxhall is covered wherever you drive in the United Kingdom. Our network of approved garages spans England, Scotland, Wales, and Northern Ireland.
                </p>
                <ul className="space-y-2 md:space-y-3 text-left max-w-md mx-auto md:mx-0">
                  {['Use any VAT-registered garage', 'Vauxhall dealer or specialist garage', 'Recovery to nearest garage', 'Claims handled by our UK team'].map((item, index) => (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-600">
                Real reviews from real Vauxhall drivers
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
