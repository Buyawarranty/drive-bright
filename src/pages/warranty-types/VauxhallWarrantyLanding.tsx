...
const VauxhallWarrantyLanding: React.FC = () => {
  ...
  const productSchema = { "@context": "https://schema.org", "@type": "Product", "name": "Vauxhall Extended Warranty UK", "description": "Comprehensive extended warranty for Vauxhall models including Corsa, Astra, Grandland, Mokka, Insignia, Crossland, Corsa-e, Mokka-e. Turbo engines, auto gearbox, EV components covered.", "brand": { "@type": "Brand", "name": "Buy A Warranty" }, "offers": { "@type": "Offer", "priceCurrency": "GBP", "price": "18", "availability": "https://schema.org/InStock", "url": "https://buyawarranty.co.uk/warranty-types/vauxhall/" }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "2847", "bestRating": "5" } };
        ...
        <section id="hero-section" className="relative bg-gradient-to-br from-red-50 via-white to-orange-50 pt-6 pb-10 md:pt-10 md:pb-16 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-5">
              <div className="inline-flex items-center gap-2 bg-red-100 text-red-700 px-4 py-2 rounded-full text-sm font-medium"><Shield className="h-4 w-4" /> Official Vauxhall Extended Warranty Partner</div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 leading-tight">Vauxhall Extended <span className="text-brand-orange">Warranty</span> UK</h1>
              <p className="text-base md:text-lg text-gray-600 max-w-xl">Protect your Vauxhall with comprehensive cover from just <strong>£18/month</strong>. All models from 2012 to 2026 including Corsa, Astra, Grandland, Mokka, Insignia & Corsa-e. Use any UK garage.</p>
              ...
              <TrustCallbackPanel />
              <div className="flex items-center gap-3"><OptimizedImage src={trustpilotExcellent} alt="Trustpilot Excellent Rating" className="h-10" width={120} height={40} /><span className="text-sm text-gray-600">Rated <strong>Excellent</strong> by Vauxhall owners</span></div>
            </div>
            <div className="relative hidden lg:flex flex-col items-center justify-center">
              <div className="relative flex items-end justify-center gap-4"><OptimizedImage src={vauxhallCorsaHero} alt="Vauxhall Corsa extended warranty UK" className="max-w-[35%] h-auto drop-shadow-2xl" priority width={269} height={179} /><OptimizedImage src={pandaThumbsUp} alt="Buy A Warranty mascot" className="max-w-[25%] h-auto" priority width={192} height={192} /><OptimizedImage src={vauxhallGrandlandWarranty} alt="Vauxhall Grandland used car warranty UK" className="max-w-[35%] h-auto drop-shadow-2xl" priority width={269} height={179} /></div>
              <div className="mt-6 flex items-center gap-2"><div className="flex -space-x-1">{[...Array(5)].map((_, i) => <Star key={i} className="h-5 w-5 fill-yellow-400 text-yellow-400" />)}</div><span className="text-sm font-medium text-gray-700">Trusted by thousands of Vauxhall owners</span></div>
            </div>
          </div></div>
        </section>
