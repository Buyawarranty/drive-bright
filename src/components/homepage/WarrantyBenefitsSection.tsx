      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-6 justify-center items-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-transparent border border-brand-orange text-brand-orange hover:bg-brand-orange hover:text-white font-bold px-8 py-4 text-base md:text-lg rounded-lg shadow-lg transition-all animate-[breathing_3s_ease-in-out_infinite]"
          >
            What's covered
