    ...
    <section className="py-12 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-brand-dark-text mb-4">
        ...
        <div className="mb-12 md:mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-brand-dark-text">
              Core Service & Repair Benefits
            </h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-base md:text-lg text-brand-dark-text">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-orange-50 rounded-2xl p-8 md:p-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-lg md:text-xl font-bold text-brand-dark-text mb-2">
          ...
          <div className="mt-10 text-center">
            <a
              ...
              className="inline-flex items-center gap-2 bg-brand-deep-blue hover:bg-blue-800 text-white font-bold px-8 py-4 text-lg rounded-lg shadow-lg transition-colors"
            >
