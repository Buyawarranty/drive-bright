                            ...
                            <>
                              ...
                              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                <div className="text-base">
                                  <span className="font-bold">Pay Monthly: £{discountedMonthlyPayment}/month</span> <span className="text-gray-600">Total £{monthlyTotal}</span> <span className="text-sm font-normal text-gray-600">– 0% APR, 12 payments</span>
                                </div>
                              ...
                              <div className="bg-green-50 border border-green-200 rounded-lg p-4 relative">
                                ...
                                <div className="text-base mt-1">
                                  <span className="font-bold text-black">Pay in Full: £{finalStripePrice}</span> <span className="text-sm font-normal text-gray-600">(Was £{originalPrice}, Now £{finalStripePrice} with extra 10% off)</span>
                                </div>
                              </div>
                            </>
                          );
