...
const StickyNavigation: React.FC = () => {
  ...
  return (
    <>
      <header className="bg-white shadow-sm py-1.5 sm:py-2 sticky top-0 z-50">
            ...
            <div className="lg:hidden flex items-center gap-1.5">
              {isTeamOpenNow() ? (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 min-h-[36px] px-3 py-1.5 rounded-lg bg-white border border-gray-200 text-gray-700 shadow-sm hover:bg-gray-50 active:scale-[0.97] transition-all"
                >
