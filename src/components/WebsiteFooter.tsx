        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li><a href="/careers/" className="hover:text-[#eb4b00] transition-colors">Careers</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li><a href="/car-extended-warranty/ford/" className="hover:text-[#eb4b00] transition-colors">Ford Warranty</a></li>
                <li><a href="/car-extended-warranty/audi/" className="hover:text-[#eb4b00] transition-colors">Audi Warranty</a></li>
                <li><a href="/car-extended-warranty/nissan/" className="hover:text-[#eb4b00] transition-colors">Nissan Warranty</a></li>
                <li><a href="/car-extended-warranty/vauxhall/" className="hover:text-[#eb4b00] transition-colors">Vauxhall Warranty</a></li>
              </ul>
            </div>
          ...
          <div className="text-center pt-8 border-t border-gray-200 mt-8">
            ...
            <p className="text-sm text-gray-600 mt-2 max-w-4xl mx-auto">
              Buyawarranty.co.uk is a trading name of Buy A Warranty Limited. Established 2016. Registered in the United Kingdom under Company number: 10314863 Registered address: Warranty House, 62 Berkhamsted Ave, Wembley, HA9 6DT, England. VAT registration number 519 1099 85
            </p>
          </div>
        </div>
      </footer>
