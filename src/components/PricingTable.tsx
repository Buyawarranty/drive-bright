...
const PricingTable: React.FC<PricingTableProps> = ({ 
  ...
  const labourRateDisplayAdjustment = useMemo(() => {
    // £40/hr = -£3/month, £50/hr (default) = 0, £70/hr = +£4/month, £100/hr = +£8/month
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-3 space-y-6">
        ...
        <div id="claim-limit-section" className={`section-header rounded-lg p-4 sm:p-6 transition-all duration-200 ${
          ...
          {/* Boost Add-On */}
          <div 
            className={`mt-4 p-3 rounded-lg border transition-all duration-200 cursor-pointer ${
              boostAddon 
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-muted-foreground">
                  £{selectedClaimLimit.toLocaleString()} → £{(selectedClaimLimit + 1000).toLocaleString()} | +£5/month <span className="text-[10px]">(12 payments, 0% APR)</span>
                </div>
              </div>
            </div>
          </div>
