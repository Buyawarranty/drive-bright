    ...
    <footer className="bg-white border-t border-gray-200 pt-12 pb-4 md:pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-xl font-bold text-gray-900 mb-3">Need advice? Have any questions?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="text-left">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-4 text-left">
              Helping UK Vauxhall owners protect their car from unexpected repair bills with flexible extended warranty cover designed for Vauxhall models.
            </p>
...
export default VauxhallPPCFooter;
