...
const MercedesPPCFooter: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="text-left">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-4 text-left">
              Helping UK Mercedes-Benz owners protect their car from unexpected repair bills with flexible extended warranty cover designed for Mercedes models.
            </p>
...
export default MercedesPPCFooter;
