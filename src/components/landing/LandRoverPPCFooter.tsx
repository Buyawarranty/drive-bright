...
const LandRoverPPCFooter: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="text-left">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-4 text-left">
              Helping UK Land Rover and Range Rover owners protect their vehicle from unexpected repair bills with flexible extended warranty cover designed for Land Rover models.
            </p>
...
export default LandRoverPPCFooter;
