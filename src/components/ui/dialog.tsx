...
>(({ className, children, hideCloseButton = false, largeCloseButton = false, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    ...
    >
      ...
      {!hideCloseButton && (
        <DialogPrimitive.Close className={cn(
          ...
          largeCloseButton && "right-3 top-3 p-1 hover:bg-muted rounded-md"
        )}>
          <X className={largeCloseButton ? "h-8 w-8" : "h-4 w-4"} />
