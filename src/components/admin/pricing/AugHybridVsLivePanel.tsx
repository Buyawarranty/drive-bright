...
const AugHybridVsLivePanel: React.FC<{
  ...
  const [cfg, setCfg] = useStickyCfg('aug-hybrid-vs-live', HYBRID_DEFAULTS);
    ...
    <div className="space-y-4">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-lg border bg-muted/30 p-4">
            ...
            <HybridSummaryChips
              ...
              multiYearLabel="Multi-year now a discount"
            />
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <PriceTestStep2
          ...
          subtitle="Exactly what agents sell today, from the live vehicle risk pricing model figures. The website Step 3 price is 10% below this figure."
          badgeText="Live"
        />
        <PriceTestStep2
