...
import { HYBRID_PRICE_UPLIFT_PCT, HYBRID_BASE_MARKER, HYBRID_ABSOLUTE_MIN_TOTAL, upliftTermMult } from './AugHybridVsLivePanel';
              ...
              <div className="rounded-md border bg-background p-3">
                ...
                <div className="mt-3 grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">{'August base '}{referenceLive ? formatGBP(referenceLive) : '—'}{' · code base '}{codeReference ? formatGBP(codeReference) : '—'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-md border bg-background p-3">
                ...
                <div className="mt-3 grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    />
                    <p className="mt-1 text-xs text-muted-foreground">{'This age band would quote '}{effectiveTarget ? formatGBP(effectiveTarget) : '—'}{' for 1 year'}</p>
                  </div>
                  <div>
              ...
              <div className="rounded-md border bg-background p-3">
                ...
                <div className="mt-3 grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    />
                    <p className="mt-1 text-xs text-muted-foreground">{'2 years costs '}{hybridModel.twoYearMult.toFixed(2)}{'× the 1-year price (code base '}{codeBaseModel.twoYearMult.toFixed(2)}{'×, '}{codeTwoYearDiscountPct}{'% off)'}</p>
                  </div>
                  <div>
                    ...
                    />
                    <p className="mt-1 text-xs text-muted-foreground">{'3 years costs '}{hybridModel.threeYearMult.toFixed(2)}{'× the 1-year price (code base '}{codeBaseModel.threeYearMult.toFixed(2)}{'×, '}{codeThreeYearDiscountPct}{'% off)'}</p>
                  </div>
                </div>
              </div>
