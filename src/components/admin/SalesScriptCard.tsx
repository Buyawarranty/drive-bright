  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <p className="italic text-sm font-medium bg-muted/50 rounded-md p-3">"If anything goes wrong, we take care of the whole process for you, so you are never left chasing garages or paperwork."</p>
      </div>
    ),
  },
  {
