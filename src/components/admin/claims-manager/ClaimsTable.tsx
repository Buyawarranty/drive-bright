            ...
            {claims.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-3 align-middle">
                    <div className="truncate max-w-[120px]" title={c.issue}>
                      {c.issue}
                    </div>
                  </td>
                  <td className="px-3 py-3 align-middle">
                    <AgePill days={c.ageInDays} />
                  </td>
                  <td className="px-3 py-3 align-middle">
                  ...
                  <td
                    className={`px-3 py-3 align-middle text-right font-mono ${
                      amountHigh ? 'text-red-600 font-semibold' : 'text-foreground'
                    }`}
                  >
                  ...
                  <td className="px-3 py-3 align-middle">
                    <div className="flex items-center justify-end gap-1">
                      <IconBtn label="Approve" className="hover:text-green-600">
                        <Check className="h-3.5 w-3.5" />
                      </IconBtn>
                      <IconBtn label="Add note" className="hover:text-blue-600">
                        <Pencil className="h-3.5 w-3.5" />
                      </IconBtn>
                      <IconBtn label="Call customer" className="hover:text-blue-600">
