...
BEGIN
  ...
  -- Manager-driven manual assignment bypasses the touched-lead protection trigger.
  -- Without this, reassigning an already-worked lead (notes/calls) silently keeps
  -- the old owner because trg_protect_touched_leads restores OLD.assigned_to.
