     ...
     SELECT id
      ...
      ORDER BY
        ...
        CASE
          ...
          ELSE 10
        END,
        -- Within a band: due callbacks first, then FRESHEST lead first
        -- (was created_at ASC — that handed agents 3-day-old leads while
        -- fresh live leads sat in the same tier).
