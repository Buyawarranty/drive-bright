...
ALTER TABLE public.sales_leads
  ADD COLUMN IF NOT EXISTS hidden_from_agent_ids uuid[] NOT NULL DEFAULT '{}'::uuid[];

CREATE INDEX IF NOT EXISTS sales_leads_hidden_from_agent_ids_idx
  ON public.sales_leads USING gin (hidden_from_agent_ids);
