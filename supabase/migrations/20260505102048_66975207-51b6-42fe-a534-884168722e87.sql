...
BEGIN
  ...
  -- TERMINAL GUARD (HARD): never resurrect lost/converted/fake leads, regardless of source.
  -- A "lost" lead must stay in the Lost tab and never reappear in New Leads.
  ...
  -- INSERT new lead (only reached when no terminal/active lead exists for this email/phone)
