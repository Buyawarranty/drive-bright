...
**Rule:** the column set is IDENTICAL between Round Robin and Open Round Robin, with exactly ONE difference — Open Round Robin adds a **Time to Lead** column (the reservation countdown / "Held for you" card).
