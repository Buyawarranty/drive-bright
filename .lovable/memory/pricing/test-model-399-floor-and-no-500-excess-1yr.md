---
name: Price Updates — £349 floor is Quotes & Orders only, not website
description: Test/proposed pricing model: £349/£576/£821 floors (cheapest combo) apply to the sales Quotes & Orders grid only; website prices have no floor; no £500 excess on 1 year
type: feature
---
...
- **Quotes & Orders floor:** never below **£349** (12mo), **£576** (24mo, ×1.65),
  **£821** (36mo, ×2.35) at the cheapest option combo — richer options step it up. Agents discount down from this grid, so the floor guards
