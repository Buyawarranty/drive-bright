...
description: Test/proposed pricing model: £399/£659/£938 floors apply to the sales Quotes & Orders grid only; website prices have no floor; no £500 excess on 1 year
type: feature
---
...
- **Quotes & Orders floor:** never below **£399** (12mo), **£659** (24mo, ×1.65),
  **£938** (36mo, ×2.35). Agents discount down from this grid, so the floor guards
  the admin cell value. Cells under the floor are flagged "Below £399 Quotes & Orders floor".
- **Website prices are NOT floored.** There is no acquisition cost on the website, so a
  derived website price below £399 (e.g. £250) is valid and displayed as-is — never raised.
