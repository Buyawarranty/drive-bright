...
description: Test/proposed pricing model: £399/£699/£999 floors (cheapest combo) apply to the sales Quotes & Orders grid only; website prices have no floor; no £500 excess on 1 year
type: feature
---
...
- **Quotes & Orders floor:** never below **£399** (12mo), **£699** (24mo, ×1.75),
  **£999** (36mo, ×2.50) at the cheapest option combo — richer options step it up. Agents discount down from this grid, so the floor guards
